...
func (a *AlertRuleApi) CreateAlertRule(ctx _context.Context, orgName string, body AlertRule) (AlertRule, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/alerts/rules"
...
func (a *AlertRuleApi) DeleteAlertRule(ctx _context.Context, orgName string, alertName string) (interface{}, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/alerts/rules/{alertName}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
func (a *AlertRuleApi) GetRuleConfig(ctx _context.Context) (string, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/alerts/rules/config"
