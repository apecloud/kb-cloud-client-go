...
func NewDiagnosticDBPerformanceLockWaitMetric(severity DiagnosticCheckSeverity, source string, dataQuality DiagnosticMetricDataQuality, reason string, lockWaitState DiagnosticDBPerformanceLockWaitState) *DiagnosticDBPerformanceLockWaitMetric {
...
func (o *DiagnosticDBPerformanceLockWaitMetric) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = common.Unmarshal(bytes, &additionalProperties); err == nil {
		common.DeleteKeys(additionalProperties, &[]string{"value", "unit", "ratio", "threshold", "severity", "source", "dataQuality", "reasonCode", "reason", "lockWaitState", "datasetSummary", "collectionError"})
	} else {
		return err
	}
