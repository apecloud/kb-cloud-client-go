...
// NodeSelectorTerm Represents a set of node selection criteria.
...
func (o *NodeSelectorTerm) GetMatchExpressions() []NodeSelectorRequirement {
...
func (o *NodeSelectorTerm) GetMatchExpressionsOk() (*[]NodeSelectorRequirement, bool) {
	if o == nil || o.MatchExpressions == nil {
		return nil, false
	}
...
func (o *NodeSelectorTerm) SetMatchExpressions(v []NodeSelectorRequirement) {
...
func (o *NodeSelectorTerm) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		MatchExpressions []NodeSelectorRequirement `json:"matchExpressions,omitempty"`
	}{}
