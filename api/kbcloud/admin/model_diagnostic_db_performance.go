...
func NewDiagnosticDBPerformance(cpu DiagnosticDBPerformanceMetric, memory DiagnosticDBPerformanceMetric, disk DiagnosticDBPerformanceMetric, connections DiagnosticDBPerformanceMetric, slowSql DiagnosticDBPerformanceSlowSQLMetric, longTransaction DiagnosticDBPerformanceLongTransactionMetric, lockWait DiagnosticDBPerformanceLockWaitMetric) *DiagnosticDBPerformance {
...
func (o *DiagnosticDBPerformance) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = common.Unmarshal(bytes, &additionalProperties); err == nil {
		common.DeleteKeys(additionalProperties, &[]string{"cpu", "memory", "disk", "connections", "slowSql", "longTransaction", "lockWait"})
	} else {
		return err
	}
