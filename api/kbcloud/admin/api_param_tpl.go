...
func (a *ParamTplApi) CreateParamTplFromCluster(ctx _context.Context, orgName string, clusterName string, body ParamTplCreateFromCluster) (*_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/paramTpls",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
...
func (a *ParamTplApi) DeleteParamTpl(ctx _context.Context, orgName string, paramTplName string) (*_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/paramTpls/{paramTplName}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
...
// DeleteParamTplV2 Delete configuration template.
func (a *ParamTplApi) DeleteParamTplV2(ctx _context.Context, orgName string, paramTplName string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)
	...
	apiInfo := common.APIInfo{
		Tag:         "paramTpl",
		OperationID: "deleteParamTplV2",
		Path:        "/admin/v1/paramTplsV2/{paramTplName}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ParamTplApi.DeleteParamTplV2")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/paramTplsV2/{paramTplName}"
	localVarPath = strings.Replace(localVarPath, "{"+"paramTplName"+"}", _neturl.PathEscape(common.ParameterToString(paramTplName, "")), -1)
...
// PatchParamTplV2 Update configuration template.
// partially update the parameter template
func (a *ParamTplApi) PatchParamTplV2(ctx _context.Context, orgName string, paramTplName string, body ParamTplUpdate) (ParamTplListItem, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPatch
		localVarPostBody    interface{}
		localVarReturnValue ParamTplListItem
	...
	apiInfo := common.APIInfo{
		Tag:         "paramTpl",
		OperationID: "patchParamTplV2",
		Path:        "/admin/v1/paramTplsV2/{paramTplName}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ParamTplApi.PatchParamTplV2")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// ReadParamTplV2OptionalParameters holds optional parameters for ReadParamTplV2.
type ReadParamTplV2OptionalParameters struct {
	Partition *ParamTplPartition
}

// NewReadParamTplV2OptionalParameters creates an empty struct for parameters.
func NewReadParamTplV2OptionalParameters() *ReadParamTplV2OptionalParameters {
	this := ReadParamTplV2OptionalParameters{}
	return &this
}

// WithPartition sets the corresponding parameter name and returns the struct.
func (r *ReadParamTplV2OptionalParameters) WithPartition(partition ParamTplPartition) *ReadParamTplV2OptionalParameters {
	r.Partition = &partition
	return r
}

// ReadParamTplV2 Get parameter template details.
func (a *ParamTplApi) ReadParamTplV2(ctx _context.Context, orgName string, paramTplName string, o ...ReadParamTplV2OptionalParameters) (ParameterPropList, *_nethttp.Response, error) {
	...
	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type ReadParamTplV2OptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	apiInfo := common.APIInfo{
		Tag:         "paramTpl",
		OperationID: "readParamTplV2",
		Path:        "/admin/v1/paramTplsV2/{paramTplName}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ParamTplApi.ReadParamTplV2")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
