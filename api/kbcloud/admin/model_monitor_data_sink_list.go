...
func NewMonitorDataSinkList(items []MonitorDataSink) *MonitorDataSinkList {
	this := MonitorDataSinkList{}
	this.Items = items
	return &this
}

// NewMonitorDataSinkListWithDefaults instantiates a new MonitorDataSinkList object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewMonitorDataSinkListWithDefaults() *MonitorDataSinkList {
	this := MonitorDataSinkList{}
	return &this
}
...
func (o *MonitorDataSinkList) GetItemsOk() (*[]MonitorDataSink, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Items, true
...
func (o *MonitorDataSinkList) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Items *[]MonitorDataSink `json:"items"`
	}{}
