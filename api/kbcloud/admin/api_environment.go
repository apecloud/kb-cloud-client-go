...
func (a *EnvironmentApi) ListEnvironmentSpiderIPPools(ctx _context.Context, environmentName string) (SpiderIPPoolList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/environments/{environmentName}/network/spiderIPPool",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/environments/{environmentName}/network/spiderIPPool"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentName"+"}", _neturl.PathEscape(common.ParameterToString(environmentName, "")), -1)
