...
func (a *OrganizationApi) FreezeMember(ctx _context.Context, orgName string, memberId string) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/members/{memberId}/freeze"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
func (a *OrganizationApi) UnfreezeMember(ctx _context.Context, orgName string, memberId string) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/members/{memberId}/unfreeze"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"memberId"+"}", _neturl.PathEscape(common.ParameterToString(memberId, "")), -1)
