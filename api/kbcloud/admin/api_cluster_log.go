...
func (a *ClusterLogApi) AggregateSlowLogs(ctx _context.Context, orgName string, clusterName string, startTime string, endTime string, o ...AggregateSlowLogsOptionalParameters) (ClusterExecutionLogAggregateResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/logs/slow/aggregate"
...
func (a *ClusterLogApi) CreateSlowLogTemplateSubscription(ctx _context.Context, orgName string, clusterName string, templateId string) (*_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/logs/slow/templates/{templateId}/subscriptions",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/logs/slow/templates/{templateId}/subscriptions"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *ClusterLogApi) ExplainSlowLog(ctx _context.Context, orgName string, clusterName string, body DmsExplainRequest) (ClusterSlowLogExplainResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/logs/slow/explain"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *ClusterLogApi) ExplainSlowLogTemplate(ctx _context.Context, orgName string, clusterName string, templateId string, startTime string, endTime string, o ...ExplainSlowLogTemplateOptionalParameters) (ClusterSlowLogExplainResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/logs/slow/templates/{templateId}/explain"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"templateId"+"}", _neturl.PathEscape(common.ParameterToString(templateId, "")), -1)
...
func (a *ClusterLogApi) GetSlowLogStats(ctx _context.Context, orgName string, clusterName string, startTime string, endTime string, o ...GetSlowLogStatsOptionalParameters) (ClusterSlowLogStats, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/logs/slow/stats"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *ClusterLogApi) ListSlowLogTemplateSubscriptions(ctx _context.Context, orgName string, clusterName string) (ClusterSlowLogTemplateSubscriptionList, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/logs/slow/template-subscriptions",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/logs/slow/template-subscriptions"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *ClusterLogApi) QueryLogHits(ctx _context.Context, orgName string, clusterName string, startTime string, endTime string, step string, logType string, o ...QueryLogHitsOptionalParameters) (ClusterLogHitsResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/logs/hits"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *ClusterLogApi) QuerySlowLogs(ctx _context.Context, orgName string, clusterName string, startTime string, endTime string, o ...QuerySlowLogsOptionalParameters) (ClusterExecutionLog, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/logs/slow",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
