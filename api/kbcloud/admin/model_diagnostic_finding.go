...
func NewDiagnosticFinding(layer DiagnosticLayer, ruleId string, status DiagnosticRuleStatus, summary string, evidence []DiagnosticEvidence, ownerHint string, redacted bool) *DiagnosticFinding {
...
func (o *DiagnosticFinding) GetOwnerHint() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DiagnosticFinding) GetOwnerHintOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DiagnosticFinding) SetOwnerHint(v string) {
	o.OwnerHint = v
}

// GetRedacted returns the Redacted field value.
func (o *DiagnosticFinding) GetRedacted() bool {
	if o == nil {
		var ret bool
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DiagnosticFinding) GetRedactedOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DiagnosticFinding) SetRedacted(v bool) {
	o.Redacted = v
}
...
func (o *DiagnosticFinding) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = common.Unmarshal(bytes, &additionalProperties); err == nil {
		common.DeleteKeys(additionalProperties, &[]string{"layer", "ruleId", "status", "summary", "evidence", "actionHint", "ownerHint", "redacted"})
	} else {
		return err
	}
