...
// CreateEngineOption Create engineOption.
// Create a new engineOption
func (a *EngineOptionApi) CreateEngineOption(ctx _context.Context, body EngineOption) (EngineOption, *_nethttp.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/admin/v1/engineOptions"
...
// DeleteEngineOption Delete engineOption.
// Delete a engineOption
func (a *EngineOptionApi) DeleteEngineOption(ctx _context.Context, engineName string) (*_nethttp.Response, error) {
	var (
	...
	apiInfo := common.APIInfo{
		Tag:         "engineOption",
		OperationID: "deleteEngineOption",
		Path:        "/admin/v1/engineOptions/{engineName}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineOptionApi.DeleteEngineOption")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/engineOptions/{engineName}"
...
// GetEngineOptionOptionalParameters holds optional parameters for GetEngineOption.
type GetEngineOptionOptionalParameters struct {
	Version *EngineOptionVersion
}

// NewGetEngineOptionOptionalParameters creates an empty struct for parameters.
func NewGetEngineOptionOptionalParameters() *GetEngineOptionOptionalParameters {
	this := GetEngineOptionOptionalParameters{}
	return &this
}

// WithVersion sets the corresponding parameter name and returns the struct.
func (r *GetEngineOptionOptionalParameters) WithVersion(version EngineOptionVersion) *GetEngineOptionOptionalParameters {
	r.Version = &version
	return r
}
...
func (a *EngineOptionApi) GetEngineOption(ctx _context.Context, engineName string, o ...GetEngineOptionOptionalParameters) (EngineOption, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue EngineOption
		optionalParams      GetEngineOptionOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type GetEngineOptionOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
...
// ListEngineOptionHistory List engineOption history.
// List a engineOption histories of a engine
func (a *EngineOptionApi) ListEngineOptionHistory(ctx _context.Context, engineName string) (EngineOptionHistoryList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
	...
	localVarPath := localBasePath + "/admin/v1/engineOptionHistories"
...
// ReleaseEngineOption Release engineOption.
// Release a engineOption
func (a *EngineOptionApi) ReleaseEngineOption(ctx _context.Context, engineName string) (EngineOption, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue EngineOption
	...
	apiInfo := common.APIInfo{
		Tag:         "engineOption",
		OperationID: "releaseEngineOption",
		Path:        "/admin/v1/engineOptions/{engineName}/release",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineOptionApi.ReleaseEngineOption")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/engineOptions/{engineName}/release"
	localVarPath = strings.Replace(localVarPath, "{"+"engineName"+"}", _neturl.PathEscape(common.ParameterToString(engineName, "")), -1)
...
// UpdateEngineOption Update engineOption.
// Update a engineOption
func (a *EngineOptionApi) UpdateEngineOption(ctx _context.Context, engineName string, body EngineOption) (EngineOption, *_nethttp.Response, error) {
	var (
