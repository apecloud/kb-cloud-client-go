...
type DiagnosticDBPerformanceLongTransactionSample struct {
	...
	// pg_stat_activity.query_start for the current or last statement in the session; falls back to transactionStart when PostgreSQL does not expose a query start.
	...
	// Redacted summary of the current query, such as statement kind plus digest. Full SQL text and literal values are not exposed.
...
func NewDiagnosticDBPerformanceLongTransactionSample(pid int64, userName string, databaseName string, transactionStart time.Time, queryStart time.Time, transactionDurationSeconds int64, state string, queryDigest string, querySummary string) *DiagnosticDBPerformanceLongTransactionSample {
...
// GetQueryStart returns the QueryStart field value.
func (o *DiagnosticDBPerformanceLongTransactionSample) GetQueryStart() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// GetQueryStartOk returns a tuple with the QueryStart field value
// and a boolean to check if the value has been set.
func (o *DiagnosticDBPerformanceLongTransactionSample) GetQueryStartOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
// SetQueryStart sets field value.
func (o *DiagnosticDBPerformanceLongTransactionSample) SetQueryStart(v time.Time) {
	o.QueryStart = v
}
...
func (o *DiagnosticDBPerformanceLongTransactionSample) GetQuerySummary() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *DiagnosticDBPerformanceLongTransactionSample) GetQuerySummaryOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *DiagnosticDBPerformanceLongTransactionSample) SetQuerySummary(v string) {
	o.QuerySummary = v
}
...
func (o DiagnosticDBPerformanceLongTransactionSample) MarshalJSON() ([]byte, error) {
	...
	if o.QueryStart.Nanosecond() == 0 {
		toSerialize["queryStart"] = o.QueryStart.Format("2006-01-02T15:04:05Z07:00")
	} else {
		toSerialize["queryStart"] = o.QueryStart.Format("2006-01-02T15:04:05.000Z07:00")
	}
...
func (o *DiagnosticDBPerformanceLongTransactionSample) UnmarshalJSON(bytes []byte) (err error) {
	...
	if all.QueryStart == nil {
		return fmt.Errorf("required field queryStart missing")
	}
	...
	if err = common.Unmarshal(bytes, &additionalProperties); err == nil {
		common.DeleteKeys(additionalProperties, &[]string{"pid", "userName", "databaseName", "applicationName", "clientAddr", "transactionStart", "queryStart", "transactionDurationSeconds", "state", "waitEventType", "waitEvent", "queryDigest", "querySummary"})
	} else {
		return err
	}
	o.Pid = *all.Pid
