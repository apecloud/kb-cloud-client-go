...
// OrganizationParameterApi service type
type OrganizationParameterApi common.Service

// BatchUpdateOrgParameters Batch update parameters of an organization.
// Batch update parameters of an organization
func (a *OrganizationParameterApi) BatchUpdateOrgParameters(ctx _context.Context, orgName string, body []OrgParameter) ([]OrgParameter, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".OrganizationParameterApi.BatchUpdateOrgParameters")
	if err != nil {
...
func (a *OrganizationParameterApi) GetOrgParameter(ctx _context.Context, orgName string, parameterName string) (OrgParameter, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".OrganizationParameterApi.GetOrgParameter")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *OrganizationParameterApi) ListOrgParameters(ctx _context.Context, orgName string, o ...ListOrgParametersOptionalParameters) ([]OrgParameter, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue []OrgParameter
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".OrganizationParameterApi.ListOrgParameters")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *OrganizationParameterApi) PatchOrgParameter(ctx _context.Context, orgName string, parameterName string, body OrgParameter) (OrgParameter, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".OrganizationParameterApi.PatchOrgParameter")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// NewOrganizationParameterApi Returns NewOrganizationParameterApi.
func NewOrganizationParameterApi(client *common.APIClient) *OrganizationParameterApi {
	return &OrganizationParameterApi{
		Client: client,
	}
}
