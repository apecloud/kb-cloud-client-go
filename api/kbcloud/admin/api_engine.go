...
func (a *EngineApi) ListUpgradeableServiceVersion(ctx _context.Context, clusterName string, orgName string, component string) (EngineServiceVersions, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/upgradeableServiceVersion"
...
func (a *EngineApi) CreateEngineLicenseEntity(ctx _context.Context, body EngineLicenseEntityCreate) (EngineLicenseEntity, *_nethttp.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		localVarReturnValue EngineLicenseEntity
	)
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.CreateEngineLicenseEntity")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
type CreateEngineSchedulingRuleOptionalParameters struct {
	Body *EngineSchedulingRule
}

// NewCreateEngineSchedulingRuleOptionalParameters creates an empty struct for parameters.
func NewCreateEngineSchedulingRuleOptionalParameters() *CreateEngineSchedulingRuleOptionalParameters {
	this := CreateEngineSchedulingRuleOptionalParameters{}
	return &this
}

// WithBody sets the corresponding parameter name and returns the struct.
func (r *CreateEngineSchedulingRuleOptionalParameters) WithBody(body EngineSchedulingRule) *CreateEngineSchedulingRuleOptionalParameters {
	r.Body = &body
	return r
}
...
func (a *EngineApi) CreateEngineSchedulingRule(ctx _context.Context, engineName string, o ...CreateEngineSchedulingRuleOptionalParameters) (EngineSchedulingRule, *_nethttp.Response, error) {
	var (
		...
		optionalParams      CreateEngineSchedulingRuleOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type CreateEngineSchedulingRuleOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.CreateEngineSchedulingRule")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *EngineApi) CreateEngineVersion(ctx _context.Context, body EngineVersionCreate) (EngineVersion, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.CreateEngineVersion")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// CreateEnvironmentEngineOption Create environment engine option.
func (a *EngineApi) CreateEnvironmentEngineOption(ctx _context.Context, environmentName string, body EnvironmentEngineOptionCreate) (EnvironmentEngineOption, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue EnvironmentEngineOption
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "engine",
		OperationID: "createEnvironmentEngineOption",
		Path:        "/admin/v1/environments/{environmentName}/engineOptions",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.CreateEnvironmentEngineOption")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// DeleteEngineLicenseEntity Delete an engine license entity by ID.
// delete an engine license entity by ID
func (a *EngineApi) DeleteEngineLicenseEntity(ctx _context.Context, entityId string) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.DeleteEngineLicenseEntity")
	if err != nil {
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	localVarQueryParams.Add("entityId", common.ParameterToString(entityId, ""))
...
func (a *EngineApi) DeleteEngineSchedulingRule(ctx _context.Context, engineName string, ruleId string) (interface{}, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.DeleteEngineSchedulingRule")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *EngineApi) DeleteEngineVersion(ctx _context.Context, o ...DeleteEngineVersionOptionalParameters) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.DeleteEngineVersion")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// DeleteEnvironmentEngineOption Delete environment engine option.
func (a *EngineApi) DeleteEnvironmentEngineOption(ctx _context.Context, environmentName string, id string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)
	...
	apiInfo := common.APIInfo{
		Tag:         "engine",
		OperationID: "deleteEnvironmentEngineOption",
		Path:        "/admin/v1/environments/{environmentName}/engineOption/{id}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.DeleteEnvironmentEngineOption")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/environments/{environmentName}/engineOption/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentName"+"}", _neturl.PathEscape(common.ParameterToString(environmentName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
// DisableServiceVersion Disable service version.
// Remove a service version from the engine version's service_versions list if no running clusters are using it
func (a *EngineApi) DisableServiceVersion(ctx _context.Context, body EngineVersionDisableServiceVersion) (EngineVersion, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue EngineVersion
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.DisableServiceVersion")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *EngineApi) EngineAction(ctx _context.Context, environmentName string, engineName string, actionInfo interface{}) (string, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/environments/{environmentName}/engines/{engineName}"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentName"+"}", _neturl.PathEscape(common.ParameterToString(environmentName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"engineName"+"}", _neturl.PathEscape(common.ParameterToString(engineName, "")), -1)
...
// GetEngineLicenseEntity Get an engine license entity by ID.
// get an engine license entity by ID
func (a *EngineApi) GetEngineLicenseEntity(ctx _context.Context, entityId string) (EngineLicenseEntity, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue EngineLicenseEntity
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.GetEngineLicenseEntity")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// GetEngineNetworkModeOptions Get available network modes for all engines from engineOption config.
func (a *EngineApi) GetEngineNetworkModeOptions(ctx _context.Context, environmentName string) ([]EngineNetworkModeOptionsItem, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue []EngineNetworkModeOptionsItem
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "engine",
		OperationID: "getEngineNetworkModeOptions",
		Path:        "/admin/v1/environments/{environmentName}/engineNetworkModes/options",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.GetEngineNetworkModeOptions")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/environments/{environmentName}/engineNetworkModes/options"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentName"+"}", _neturl.PathEscape(common.ParameterToString(environmentName, "")), -1)
...
// GetEngineNetworkModeSupported Get supported network modes for engine+mode from engineOption config.
func (a *EngineApi) GetEngineNetworkModeSupported(ctx _context.Context, environmentName string, engineName string, mode string) (EngineNetworkModeSupported, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue EngineNetworkModeSupported
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "engine",
		OperationID: "getEngineNetworkModeSupported",
		Path:        "/admin/v1/environments/{environmentName}/engineNetworkModes/supported",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.GetEngineNetworkModeSupported")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/environments/{environmentName}/engineNetworkModes/supported"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentName"+"}", _neturl.PathEscape(common.ParameterToString(environmentName, "")), -1)
...
// NewListAllEnginesOptionalParameters creates an empty struct for parameters.
func NewListAllEnginesOptionalParameters() *ListAllEnginesOptionalParameters {
	this := ListAllEnginesOptionalParameters{}
	return &this
}

// WithName sets the corresponding parameter name and returns the struct.
func (r *ListAllEnginesOptionalParameters) WithName(name string) *ListAllEnginesOptionalParameters {
	r.Name = &name
	return r
}
...
func (r *ListAllEnginesOptionalParameters) WithVersion(version string) *ListAllEnginesOptionalParameters {
	r.Version = &version
	return r
}

// WithProvider sets the corresponding parameter name and returns the struct.
func (r *ListAllEnginesOptionalParameters) WithProvider(provider string) *ListAllEnginesOptionalParameters {
	r.Provider = &provider
	return r
}

// WithAll sets the corresponding parameter name and returns the struct.
func (r *ListAllEnginesOptionalParameters) WithAll(all bool) *ListAllEnginesOptionalParameters {
	r.All = &all
	return r
}

// ListAllEngines List all engines.
func (a *EngineApi) ListAllEngines(ctx _context.Context, o ...ListAllEnginesOptionalParameters) ([]Engine, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue []Engine
		optionalParams      ListAllEnginesOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type ListAllEnginesOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	localVarPath := localBasePath + "/admin/v1/engines"
...
// ListEngineLicenseEntities List all engine license entities by license ID.
// list all engine license entities by license ID
func (a *EngineApi) ListEngineLicenseEntities(ctx _context.Context, licenseId string) (EngineLicenseEntityList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue EngineLicenseEntityList
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "engine",
		OperationID: "listEngineLicenseEntities",
		Path:        "/admin/v1/engineLicenseEntities",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.ListEngineLicenseEntities")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/engineLicenseEntities"
...
func (r *ListEngineSchedulingRulesOptionalParameters) WithSchedulingPolicyType(schedulingPolicyType string) *ListEngineSchedulingRulesOptionalParameters {
	r.SchedulingPolicyType = &schedulingPolicyType
	return r
}

// ListEngineSchedulingRules List engine scheduling rules.
func (a *EngineApi) ListEngineSchedulingRules(ctx _context.Context, engineName string, o ...ListEngineSchedulingRulesOptionalParameters) ([]EngineSchedulingRule, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue []EngineSchedulingRule
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.ListEngineSchedulingRules")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *EngineApi) ListEngineVersions(ctx _context.Context, engineName string) (EngineVersionList, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.ListEngineVersions")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *EngineApi) ListEnginesInEnv(ctx _context.Context, environmentName string, o ...ListEnginesInEnvOptionalParameters) ([]Engine, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/environments/{environmentName}/engines"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentName"+"}", _neturl.PathEscape(common.ParameterToString(environmentName, "")), -1)
...
// ListEnvironmentEngineOptionsOptionalParameters holds optional parameters for ListEnvironmentEngineOptions.
type ListEnvironmentEngineOptionsOptionalParameters struct {
	EngineName *string
	Mode       *string
}

// NewListEnvironmentEngineOptionsOptionalParameters creates an empty struct for parameters.
func NewListEnvironmentEngineOptionsOptionalParameters() *ListEnvironmentEngineOptionsOptionalParameters {
	this := ListEnvironmentEngineOptionsOptionalParameters{}
	return &this
}

// WithEngineName sets the corresponding parameter name and returns the struct.
func (r *ListEnvironmentEngineOptionsOptionalParameters) WithEngineName(engineName string) *ListEnvironmentEngineOptionsOptionalParameters {
	r.EngineName = &engineName
	return r
}

// WithMode sets the corresponding parameter name and returns the struct.
func (r *ListEnvironmentEngineOptionsOptionalParameters) WithMode(mode string) *ListEnvironmentEngineOptionsOptionalParameters {
	r.Mode = &mode
	return r
}

// ListEnvironmentEngineOptions List environment engine options.
func (a *EngineApi) ListEnvironmentEngineOptions(ctx _context.Context, environmentName string, o ...ListEnvironmentEngineOptionsOptionalParameters) ([]EnvironmentEngineOption, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue []EnvironmentEngineOption
		optionalParams      ListEnvironmentEngineOptionsOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type ListEnvironmentEngineOptionsOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	apiInfo := common.APIInfo{
		Tag:         "engine",
		OperationID: "listEnvironmentEngineOptions",
		Path:        "/admin/v1/environments/{environmentName}/engineOptions",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.ListEnvironmentEngineOptions")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// PatchEngineSchedulingPolicyOptionalParameters holds optional parameters for PatchEngineSchedulingPolicy.
type PatchEngineSchedulingPolicyOptionalParameters struct {
	Body *EngineSchedulingPolicy
}

// NewPatchEngineSchedulingPolicyOptionalParameters creates an empty struct for parameters.
func NewPatchEngineSchedulingPolicyOptionalParameters() *PatchEngineSchedulingPolicyOptionalParameters {
	this := PatchEngineSchedulingPolicyOptionalParameters{}
	return &this
}

// WithBody sets the corresponding parameter name and returns the struct.
func (r *PatchEngineSchedulingPolicyOptionalParameters) WithBody(body EngineSchedulingPolicy) *PatchEngineSchedulingPolicyOptionalParameters {
	r.Body = &body
	return r
}

// PatchEngineSchedulingPolicy Patch engine scheduling policy.
func (a *EngineApi) PatchEngineSchedulingPolicy(ctx _context.Context, engineName string, engineMode string, o ...PatchEngineSchedulingPolicyOptionalParameters) (EngineSchedulingPolicy, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPatch
		localVarPostBody    interface{}
		localVarReturnValue EngineSchedulingPolicy
		optionalParams      PatchEngineSchedulingPolicyOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type PatchEngineSchedulingPolicyOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.PatchEngineSchedulingPolicy")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// PatchEngineSchedulingRuleOptionalParameters holds optional parameters for PatchEngineSchedulingRule.
type PatchEngineSchedulingRuleOptionalParameters struct {
	Body *EngineSchedulingRule
}

// NewPatchEngineSchedulingRuleOptionalParameters creates an empty struct for parameters.
func NewPatchEngineSchedulingRuleOptionalParameters() *PatchEngineSchedulingRuleOptionalParameters {
	this := PatchEngineSchedulingRuleOptionalParameters{}
	return &this
}

// WithBody sets the corresponding parameter name and returns the struct.
func (r *PatchEngineSchedulingRuleOptionalParameters) WithBody(body EngineSchedulingRule) *PatchEngineSchedulingRuleOptionalParameters {
	r.Body = &body
	return r
}
...
func (a *EngineApi) PatchEngineSchedulingRule(ctx _context.Context, engineName string, ruleId string, o ...PatchEngineSchedulingRuleOptionalParameters) (EngineSchedulingRule, *_nethttp.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		localVarReturnValue EngineSchedulingRule
		optionalParams      PatchEngineSchedulingRuleOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type PatchEngineSchedulingRuleOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.PatchEngineSchedulingRule")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *EngineApi) PatchEngineVersion(ctx _context.Context, body EngineVersionUpdate) (EngineVersion, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPatch
		localVarPostBody    interface{}
		localVarReturnValue EngineVersion
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.PatchEngineVersion")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// RefreshEngineInEnv Refresh the installed addon without changing its version.
// Resolves the current chart image tag in the environment registry and applies its digest, preserving the addon version and values. No request body.
// Returns 200 if the image reference is unchanged, or 202 when a refresh is requested.
// Poll listEnginesInEnv for Enabling, Enabled, or Failed status.
func (a *EngineApi) RefreshEngineInEnv(ctx _context.Context, environmentName string, engineName string) (string, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue string
	...
	apiInfo := common.APIInfo{
		Tag:         "engine",
		OperationID: "refreshEngineInEnv",
		Path:        "/admin/v1/environments/{environmentName}/engines/{engineName}/refresh",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.RefreshEngineInEnv")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/environments/{environmentName}/engines/{engineName}/refresh"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentName"+"}", _neturl.PathEscape(common.ParameterToString(environmentName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"engineName"+"}", _neturl.PathEscape(common.ParameterToString(engineName, "")), -1)
...
// UpdateEnvironmentEngineOption Update environment engine option.
func (a *EngineApi) UpdateEnvironmentEngineOption(ctx _context.Context, environmentName string, id string, body EnvironmentEngineOptionUpdate) (EnvironmentEngineOption, *_nethttp.Response, error) {
	var (
	...
	apiInfo := common.APIInfo{
		Tag:         "engine",
		OperationID: "updateEnvironmentEngineOption",
		Path:        "/admin/v1/environments/{environmentName}/engineOption/{id}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".EngineApi.UpdateEnvironmentEngineOption")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
