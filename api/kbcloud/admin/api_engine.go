...
// Refreshes the addon asynchronously using its current chart and values. No request body.
// Poll listEnginesInEnv for Enabling, Enabled, or Failed status.
// Returns 409 if the addon is disabled, busy, or awaiting installation cleanup.
