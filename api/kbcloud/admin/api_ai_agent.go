...
func (a *AIAgentApi) ApproveAIAgentToolApprovalRequest(ctx _context.Context, orgName string, runId string, approvalRequestId string, body AiAgentToolApprovalDecisionRequest) (AiAgentToolApprovalDecisionResponse, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}/tool-approvals/{approvalRequestId}/approve",
		Version:     "",
	}
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}/tool-approvals/{approvalRequestId}/approve"
...
func (a *AIAgentApi) BatchGetAIAgentArtifacts(ctx _context.Context, orgName string, body AiAgentArtifactBatchGetRequest) (AiAgentArtifactBatch, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/ai-agent/artifacts:batchGet",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/ai-agent/artifacts:batchGet"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
func (a *AIAgentApi) CancelAIAgentRun(ctx _context.Context, orgName string, runId string) (AiAgentRunControlResponse, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}/cancel",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}/cancel"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", _neturl.PathEscape(common.ParameterToString(runId, "")), -1)
...
func (a *AIAgentApi) CancelAIAgentToolApprovalRequest(ctx _context.Context, orgName string, runId string, approvalRequestId string, body AiAgentToolApprovalDecisionRequest) (AiAgentToolApprovalDecisionResponse, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}/tool-approvals/{approvalRequestId}/cancel",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}/tool-approvals/{approvalRequestId}/cancel"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", _neturl.PathEscape(common.ParameterToString(runId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"approvalRequestId"+"}", _neturl.PathEscape(common.ParameterToString(approvalRequestId, "")), -1)
...
func (a *AIAgentApi) ContinueAIAgentRun(ctx _context.Context, orgName string, runId string, body AiAgentContinueRunRequest) (AiAgentContinueRunResponse, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}/messages",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}/messages"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", _neturl.PathEscape(common.ParameterToString(runId, "")), -1)
...
func (a *AIAgentApi) GetAIAgentContext(ctx _context.Context, orgName string, clusterName string, o ...GetAIAgentContextOptionalParameters) (AiAgentContextResponse, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/ai-agent/context",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/ai-agent/context"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
func (a *AIAgentApi) GetAIAgentReport(ctx _context.Context, orgName string, runId string) (AiAgentReport, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}/report",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}/report"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", _neturl.PathEscape(common.ParameterToString(runId, "")), -1)
...
func (a *AIAgentApi) GetAIAgentRun(ctx _context.Context, orgName string, runId string) (AiAgentRun, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", _neturl.PathEscape(common.ParameterToString(runId, "")), -1)
...
func (a *AIAgentApi) ListAIAgentConversationReports(ctx _context.Context, orgName string, conversationId string, o ...ListAIAgentConversationReportsOptionalParameters) (AiAgentReportList, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/reports",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/reports"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"conversationId"+"}", _neturl.PathEscape(common.ParameterToString(conversationId, "")), -1)
...
func (a *AIAgentApi) PauseAIAgentRun(ctx _context.Context, orgName string, runId string) (AiAgentRunControlResponse, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}/pause",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}/pause"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", _neturl.PathEscape(common.ParameterToString(runId, "")), -1)
...
func (a *AIAgentApi) RejectAIAgentToolApprovalRequest(ctx _context.Context, orgName string, runId string, approvalRequestId string, body AiAgentToolApprovalDecisionRequest) (AiAgentToolApprovalDecisionResponse, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}/tool-approvals/{approvalRequestId}/reject",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}/tool-approvals/{approvalRequestId}/reject"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", _neturl.PathEscape(common.ParameterToString(runId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"approvalRequestId"+"}", _neturl.PathEscape(common.ParameterToString(approvalRequestId, "")), -1)
...
func (a *AIAgentApi) ResumeAIAgentRun(ctx _context.Context, orgName string, runId string) (AiAgentRunControlResponse, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}/resume",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}/resume"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", _neturl.PathEscape(common.ParameterToString(runId, "")), -1)
...
func (a *AIAgentApi) StartAIAgentRun(ctx _context.Context, orgName string, conversationId string, body AiAgentStartRunRequest) (AiAgentStartRunResponse, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/runs",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/runs"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"conversationId"+"}", _neturl.PathEscape(common.ParameterToString(conversationId, "")), -1)
...
func (a *AIAgentApi) SubscribeAIAgentRunEvents(ctx _context.Context, orgName string, runId string, o ...SubscribeAIAgentRunEventsOptionalParameters) (AiAgentEvent, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}/events",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/ai-agent/runs/{runId}/events"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"runId"+"}", _neturl.PathEscape(common.ParameterToString(runId, "")), -1)
