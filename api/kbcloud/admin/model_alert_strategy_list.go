...
// NewAlertStrategyList instantiates a new AlertStrategyList object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewAlertStrategyList(items []AlertStrategy) *AlertStrategyList {
	this := AlertStrategyList{}
	this.Items = items
	return &this
}

// NewAlertStrategyListWithDefaults instantiates a new AlertStrategyList object.
