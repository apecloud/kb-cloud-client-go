...
type EngineLicenseCreate struct {
	...
	// The license file to upload. Required when type is not NodeScope; optional when type is NodeScope. For engines with engineOption.license.files, upload a JSON license bundle through this field keyed by each file slot's field or target name, with base64-encoded file content.
