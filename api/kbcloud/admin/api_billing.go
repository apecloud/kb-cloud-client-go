...
func (a *BillingApi) ListBills(ctx _context.Context, aggregationTime AggregationTimeType, aggregationGroup AggregationGroupType, start int64, end int64, o ...ListBillsOptionalParameters) (BillList, *_nethttp.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/admin/v1/bills"
...
// RefreshBills Refresh bill.
func (a *BillingApi) RefreshBills(ctx _context.Context, start int64, end int64) (BasicTask, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue BasicTask
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "billing",
		OperationID: "refreshBills",
		Path:        "/admin/v1/bills/refresh",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".BillingApi.RefreshBills")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/bills/refresh"
