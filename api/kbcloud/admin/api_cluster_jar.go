...
func (a *ClusterJarApi) ArchiveClusterJar(ctx _context.Context, orgName string, clusterName string, jarId string) (*_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/jars/{jarId}/archive",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterJarApi.ArchiveClusterJar")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/jars/{jarId}/archive"
...
// ConfigureClusterJars Enable external JAR management using an object storage repository.
func (a *ClusterJarApi) ConfigureClusterJars(ctx _context.Context, orgName string, clusterName string, body ClusterJarConfigure) (ClusterJarTask, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPut
		localVarPostBody    interface{}
		localVarReturnValue ClusterJarTask
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "clusterJar",
		OperationID: "configureClusterJars",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/jars/config",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterJarApi.ConfigureClusterJars")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/jars/config"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *ClusterJarApi) DeleteClusterJar(ctx _context.Context, orgName string, clusterName string, jarId string) (*_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/jars/{jarId}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterJarApi.DeleteClusterJar")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/jars/{jarId}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"jarId"+"}", _neturl.PathEscape(common.ParameterToString(jarId, "")), -1)
...
func (a *ClusterJarApi) DistributeClusterJar(ctx _context.Context, orgName string, clusterName string, jarId string, body ClusterJarPublish) (ClusterJarTask, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/jars/{jarId}/distribute",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterJarApi.DistributeClusterJar")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/jars/{jarId}/distribute"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"jarId"+"}", _neturl.PathEscape(common.ParameterToString(jarId, "")), -1)
...
func (a *ClusterJarApi) DownloadClusterJar(ctx _context.Context, orgName string, clusterName string, jarId string) (_io.Reader, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/jars/{jarId}/download",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterJarApi.DownloadClusterJar")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/jars/{jarId}/download"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"jarId"+"}", _neturl.PathEscape(common.ParameterToString(jarId, "")), -1)
...
func (a *ClusterJarApi) GetClusterJar(ctx _context.Context, orgName string, clusterName string, jarId string) (ClusterJarPackage, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue ClusterJarPackage
	)
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterJarApi.GetClusterJar")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *ClusterJarApi) GetClusterJarConfig(ctx _context.Context, orgName string, clusterName string) (ClusterJarConfig, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue ClusterJarConfig
	)
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterJarApi.GetClusterJarConfig")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *ClusterJarApi) GetClusterJarInstances(ctx _context.Context, orgName string, clusterName string, jarId string) (ClusterJarPackage, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/jars/{jarId}/instances",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterJarApi.GetClusterJarInstances")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/jars/{jarId}/instances"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"jarId"+"}", _neturl.PathEscape(common.ParameterToString(jarId, "")), -1)
...
func (a *ClusterJarApi) ListClusterJars(ctx _context.Context, orgName string, clusterName string) (ClusterJarList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue ClusterJarList
	)
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/jars",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterJarApi.ListClusterJars")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/jars"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *ClusterJarApi) RetryClusterJar(ctx _context.Context, orgName string, clusterName string, jarId string) (ClusterJarTask, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/jars/{jarId}/retry",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterJarApi.RetryClusterJar")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/jars/{jarId}/retry"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"jarId"+"}", _neturl.PathEscape(common.ParameterToString(jarId, "")), -1)
...
func (a *ClusterJarApi) UploadClusterJar(ctx _context.Context, orgName string, clusterName string, idempotencyKey string, name string, kind ClusterJarKind, file _io.Reader) (ClusterJarPackage, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterJarApi.UploadClusterJar")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if common.Strlen(idempotencyKey) < 1 {
		return localVarReturnValue, nil, common.ReportError("idempotencyKey must have at least 1 elements")
	}
	if common.Strlen(idempotencyKey) > 128 {
		return localVarReturnValue, nil, common.ReportError("idempotencyKey must have less than 128 elements")
	}
	if common.Strlen(name) < 1 {
		return localVarReturnValue, nil, common.ReportError("name must have at least 1 elements")
	}
	if common.Strlen(name) > 128 {
	...
	localVarFormParams.Set("kind", common.ParameterToString(kind, ""))
...
// NewClusterJarApi Returns NewClusterJarApi.
func NewClusterJarApi(client *common.APIClient) *ClusterJarApi {
	return &ClusterJarApi{
		Client: client,
	}
}
