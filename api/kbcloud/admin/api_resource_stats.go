...
// ResourceStatsApi service type
type ResourceStatsApi common.Service

// CollectResourceStats Collect resource statistics of environment.
// Triggers an immediate collection of resource statistics for the specified environment.
func (a *ResourceStatsApi) CollectResourceStats(ctx _context.Context, environmentName string) (*_nethttp.Response, error) {
	var (
	...
	apiInfo := common.APIInfo{
		Tag:         "resourceStats",
		OperationID: "collectResourceStats",
		Path:        "/admin/v1/environments/{environmentName}/resourceStats/collect",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ResourceStatsApi.CollectResourceStats")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/environments/{environmentName}/resourceStats/collect"
...
func (a *ResourceStatsApi) GetResourceStats(ctx _context.Context, environmentName string) (EnvironmentResourceStats, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/environments/{environmentName}/resourceStats"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentName"+"}", _neturl.PathEscape(common.ParameterToString(environmentName, "")), -1)
...
func (a *ResourceStatsApi) ListInstancesResourceStats(ctx _context.Context, environmentName string, nodeName string) (InstanceResourceStatsList, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/environments/{environmentName}/nodes/{nodeName}/instances/resourceStats"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentName"+"}", _neturl.PathEscape(common.ParameterToString(environmentName, "")), -1)
...
func (a *ResourceStatsApi) ListNodesResourceStats(ctx _context.Context, environmentName string) (NodeResourceStatsList, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/environments/{environmentName}/nodes/resourceStats"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentName"+"}", _neturl.PathEscape(common.ParameterToString(environmentName, "")), -1)
...
// NewResourceStatsApi Returns NewResourceStatsApi.
func NewResourceStatsApi(client *common.APIClient) *ResourceStatsApi {
	return &ResourceStatsApi{
		Client: client,
	}
}
