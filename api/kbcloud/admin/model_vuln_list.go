...
// VulnList a list of vulnerabilities
type VulnList struct {
	// a list of vulnerabilities
	Items []VulnListItem `json:"items"`
	// PageResult info
...
// NewVulnList instantiates a new VulnList object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewVulnList(items []VulnListItem) *VulnList {
	this := VulnList{}
	this.Items = items
	return &this
}

// NewVulnListWithDefaults instantiates a new VulnList object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewVulnListWithDefaults() *VulnList {
	this := VulnList{}
	return &this
}

// GetItems returns the Items field value.
func (o *VulnList) GetItems() []VulnListItem {
	if o == nil {
		var ret []VulnListItem
		return ret
	}
	return o.Items
}
...
func (o *VulnList) GetItemsOk() (*[]VulnListItem, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Items, true
...
func (o *VulnList) SetItems(v []VulnListItem) {
	o.Items = v
}

// GetPageResult returns the PageResult field value if set, zero value otherwise.
func (o *VulnList) GetPageResult() PageResult {
...
// and a boolean to check if the value has been set.
func (o *VulnList) GetPageResultOk() (*PageResult, bool) {
	if o == nil || o.PageResult == nil {
		return nil, false
	}
...
func (o *VulnList) HasPageResult() bool {
...
func (o *VulnList) SetPageResult(v PageResult) {
	o.PageResult = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o VulnList) MarshalJSON() ([]byte, error) {
...
func (o *VulnList) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		Items      *[]VulnListItem `json:"items"`
		PageResult *PageResult     `json:"pageResult,omitempty"`
	}{}
