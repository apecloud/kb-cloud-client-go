...
func (a *StorageClassApi) CreateStorageClass(ctx _context.Context, environmentName string, body StorageClassCreate) (StorageClassInfo, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/environments/{environmentName}/storageClasses"
...
func (a *StorageClassApi) DeleteStorageClass(ctx _context.Context, environmentName string, storageClassName string) (interface{}, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/environments/{environmentName}/storageClasses/{storageClassName}"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentName"+"}", _neturl.PathEscape(common.ParameterToString(environmentName, "")), -1)
...
func (a *StorageClassApi) ListStorageClassPvcs(ctx _context.Context, environmentName string, storageClassName string, pageId int64, pageSize int64, o ...ListStorageClassPvcsOptionalParameters) (PersistentVolumeClaimList, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/environments/{environmentName}/storageClasses/{storageClassName}/pvcs"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentName"+"}", _neturl.PathEscape(common.ParameterToString(environmentName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"storageClassName"+"}", _neturl.PathEscape(common.ParameterToString(storageClassName, "")), -1)
...
func (a *StorageClassApi) ListStorageProvisioners(ctx _context.Context, environmentName string) (StorageProvisionerList, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/environments/{environmentName}/storageProvisioners"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentName"+"}", _neturl.PathEscape(common.ParameterToString(environmentName, "")), -1)
