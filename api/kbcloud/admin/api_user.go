...
func (a *UserApi) CreateUser(ctx _context.Context, body UserCreate) (User, *_nethttp.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 || localVarHTTPResponse.StatusCode == 401 || localVarHTTPResponse.StatusCode == 409 {
...
// delete user
func (a *UserApi) DeleteUser(ctx _context.Context, userId string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".UserApi.DeleteUser")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *UserApi) GetAuthenticatedUser(ctx _context.Context) (User, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".UserApi.GetAuthenticatedUser")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/user"
...
// GetUserAuthorization Get user roles in multiple organizations.
// Get user roles in multiple organizations
func (a *UserApi) GetUserAuthorization(ctx _context.Context, userId string) ([]UserOrgRole, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue []UserOrgRole
	)
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".UserApi.GetUserAuthorization")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/users/{userID}/authorization"
	localVarPath = strings.Replace(localVarPath, "{"+"userID"+"}", _neturl.PathEscape(common.ParameterToString(userId, "")), -1)
...
// GrantUserAuthorization Grant user roles in multiple organizations.
// Grant user roles in multiple organizations
func (a *UserApi) GrantUserAuthorization(ctx _context.Context, userId string, body UserAuthorizationIncremental) (*_nethttp.Response, error) {
	var (
	...
	apiInfo := common.APIInfo{
		Tag:         "user",
		OperationID: "grantUserAuthorization",
		Path:        "/admin/v1/users/{userID}/authorization",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".UserApi.GrantUserAuthorization")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// List users
func (a *UserApi) ListUsers(ctx _context.Context) (UserList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".UserApi.ListUsers")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// PatchUser Update the information of the specified user.
// Update the information of the specified user
func (a *UserApi) PatchUser(ctx _context.Context, userId string, body UserUpdate) (User, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPatch
		localVarPostBody    interface{}
		localVarReturnValue User
...
// UpdateAuthenticatedUserPassword Update current authenticated user password.
// Update current authenticated user password.
func (a *UserApi) UpdateAuthenticatedUserPassword(ctx _context.Context, body interface{}) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPatch
		localVarPostBody   interface{}
	)
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".UserApi.UpdateAuthenticatedUserPassword")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/user/password"
...
func (a *UserApi) UpdateUserPassword(ctx _context.Context, userId string, body Password) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPatch
		localVarPostBody   interface{}
	)
