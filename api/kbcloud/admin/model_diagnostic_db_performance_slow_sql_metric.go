...
func NewDiagnosticDBPerformanceSlowSQLMetric(severity DiagnosticCheckSeverity, source string, dataQuality DiagnosticMetricDataQuality, reason string, slowSqlState DiagnosticDBPerformanceSlowSQLState) *DiagnosticDBPerformanceSlowSQLMetric {
...
func (o *DiagnosticDBPerformanceSlowSQLMetric) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = common.Unmarshal(bytes, &additionalProperties); err == nil {
		common.DeleteKeys(additionalProperties, &[]string{"value", "unit", "ratio", "threshold", "severity", "source", "dataQuality", "reasonCode", "reason", "slowSqlState", "datasetSummary", "timeWindow", "collectionError"})
	} else {
		return err
	}
