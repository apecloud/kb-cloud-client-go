...
// KafkaApi service type
type KafkaApi common.Service
...
func (a *KafkaApi) BatchDeleteKafkaTopics(ctx _context.Context, orgName string, clusterName string, body BatchDeleteKafkaTopicsRequest) (*_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topics/batch-delete",
		Version:     "",
	}
	...
	localVarPath := localBasePath + "/admin/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topics/batch-delete"
...
func (a *KafkaApi) CreateKafkaTopic(ctx _context.Context, orgName string, clusterName string, body CreateTopicRequest) (Topic, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topics"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *KafkaApi) DeleteKafkaConsumerGroup(ctx _context.Context, orgName string, clusterName string, groupId string) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/consumer-groups/{groupId}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *KafkaApi) DeleteKafkaTopic(ctx _context.Context, orgName string, clusterName string, topic string) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topic/{topic}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *KafkaApi) ExpandKafkaTopicPartitions(ctx _context.Context, orgName string, clusterName string, topic string, body ExpandPartitionRequest) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topic/{topic}/partitions"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"topic"+"}", _neturl.PathEscape(common.ParameterToString(topic, "")), -1)
...
func (a *KafkaApi) GetKafkaBrokerConfigs(ctx _context.Context, orgName string, clusterName string, brokerId int32) ([]ConfigEntry, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/brokers/{brokerId}/configs"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *KafkaApi) GetKafkaBrokers(ctx _context.Context, orgName string, clusterName string) ([]Broker, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/brokers"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *KafkaApi) GetKafkaTopicBrokers(ctx _context.Context, orgName string, clusterName string, topic string) ([]Broker, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topic/{topic}/brokers"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"topic"+"}", _neturl.PathEscape(common.ParameterToString(topic, "")), -1)
...
func (a *KafkaApi) GetKafkaTopicConfig(ctx _context.Context, orgName string, clusterName string, topic string) ([][]ConfigEntry, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topic/{topic}/configs"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"topic"+"}", _neturl.PathEscape(common.ParameterToString(topic, "")), -1)
...
func NewGetKafkaTopicsOptionalParameters() *GetKafkaTopicsOptionalParameters {
...
func (a *KafkaApi) GetKafkaTopics(ctx _context.Context, orgName string, clusterName string, o ...GetKafkaTopicsOptionalParameters) (TopicsList, *_nethttp.Response, error) {
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if optionalParams.NameFilter != nil {
		localVarQueryParams.Add("nameFilter", common.ParameterToString(*optionalParams.NameFilter, ""))
	}
	if optionalParams.OnlyNames != nil {
		localVarQueryParams.Add("onlyNames", common.ParameterToString(*optionalParams.OnlyNames, ""))
	}
	localVarHeaderParams["Accept"] = "application/json"
...
// ListKafkaConsumerGroupsOptionalParameters holds optional parameters for ListKafkaConsumerGroups.
type ListKafkaConsumerGroupsOptionalParameters struct {
	GroupId *string
}

// NewListKafkaConsumerGroupsOptionalParameters creates an empty struct for parameters.
func NewListKafkaConsumerGroupsOptionalParameters() *ListKafkaConsumerGroupsOptionalParameters {
...
func (a *KafkaApi) ListKafkaConsumerGroups(ctx _context.Context, orgName string, clusterName string, o ...ListKafkaConsumerGroupsOptionalParameters) ([]ConsumerGroup, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/consumer-groups"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if optionalParams.GroupId != nil {
		localVarQueryParams.Add("groupId", common.ParameterToString(*optionalParams.GroupId, ""))
	}
	localVarHeaderParams["Accept"] = "application/json"
...
func (a *KafkaApi) ListKafkaTopicConsumerGroups(ctx _context.Context, orgName string, clusterName string, topic string) ([]ConsumerGroup, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topic/{topic}/consumer-groups"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"topic"+"}", _neturl.PathEscape(common.ParameterToString(topic, "")), -1)
...
func (a *KafkaApi) ListKafkaTopicConsumerOffsets(ctx _context.Context, orgName string, clusterName string, topic string, groupId string) ([]TopicOffset, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topic/{topic}/consumer-groups/{groupId}/offsets"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"topic"+"}", _neturl.PathEscape(common.ParameterToString(topic, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"groupId"+"}", _neturl.PathEscape(common.ParameterToString(groupId, "")), -1)
...
// NewListKafkaTopicMessagesOptionalParameters creates an empty struct for parameters.
func NewListKafkaTopicMessagesOptionalParameters() *ListKafkaTopicMessagesOptionalParameters {
...
func (a *KafkaApi) ListKafkaTopicMessages(ctx _context.Context, orgName string, clusterName string, topic string, partition int32, offset int32, o ...ListKafkaTopicMessagesOptionalParameters) ([]TopicMessage, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topic/{topic}/messages"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"topic"+"}", _neturl.PathEscape(common.ParameterToString(topic, "")), -1)
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	localVarQueryParams.Add("partition", common.ParameterToString(partition, ""))
	localVarQueryParams.Add("offset", common.ParameterToString(offset, ""))
	if optionalParams.Count != nil {
		localVarQueryParams.Add("count", common.ParameterToString(*optionalParams.Count, ""))
	}
	if optionalParams.KeyFilter != nil {
		localVarQueryParams.Add("keyFilter", common.ParameterToString(*optionalParams.KeyFilter, ""))
	}
	if optionalParams.ValueFilter != nil {
		localVarQueryParams.Add("valueFilter", common.ParameterToString(*optionalParams.ValueFilter, ""))
	}
	localVarHeaderParams["Accept"] = "application/json"
...
// NewListKafkaTopicMessagesLiveOptionalParameters creates an empty struct for parameters.
func NewListKafkaTopicMessagesLiveOptionalParameters() *ListKafkaTopicMessagesLiveOptionalParameters {
...
func (a *KafkaApi) ListKafkaTopicMessagesLive(ctx _context.Context, orgName string, clusterName string, topic string, o ...ListKafkaTopicMessagesLiveOptionalParameters) (LiveMessage, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topic/{topic}/messages/live",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/data/kafka/organizations/{orgName}/clusters/{clusterName}/topic/{topic}/messages/live"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"topic"+"}", _neturl.PathEscape(common.ParameterToString(topic, "")), -1)
...
// NewKafkaApi Returns NewKafkaApi.
func NewKafkaApi(client *common.APIClient) *KafkaApi {
	return &KafkaApi{
		Client: client,
	}
}
