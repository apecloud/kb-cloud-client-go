...
func (a *AlertStrategyApi) CreateAlertStrategy(ctx _context.Context, orgName string, body AlertStrategy) (AlertStrategy, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/alerts/strategies"
...
func (a *AlertStrategyApi) ListAlertStrategies(ctx _context.Context, o ...ListAlertStrategiesOptionalParameters) (AlertStrategyList, *_nethttp.Response, error) {
	var (
