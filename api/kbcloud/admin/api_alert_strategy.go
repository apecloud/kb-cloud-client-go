...
func (a *AlertStrategyApi) DeleteAlertStrategyInOrg(ctx _context.Context, orgName string, strategyId string) (interface{}, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/alerts/strategies/{strategyId}"
...
// PatchAlertStrategyOptionalParameters holds optional parameters for PatchAlertStrategy.
type PatchAlertStrategyOptionalParameters struct {
	OrgName *string
}

// NewPatchAlertStrategyOptionalParameters creates an empty struct for parameters.
func NewPatchAlertStrategyOptionalParameters() *PatchAlertStrategyOptionalParameters {
	this := PatchAlertStrategyOptionalParameters{}
	return &this
}

// WithOrgName sets the corresponding parameter name and returns the struct.
func (r *PatchAlertStrategyOptionalParameters) WithOrgName(orgName string) *PatchAlertStrategyOptionalParameters {
	r.OrgName = &orgName
	return r
}
...
func (a *AlertStrategyApi) PatchAlertStrategy(ctx _context.Context, level AlertLevel, strategyId string, body AlertStrategy, o ...PatchAlertStrategyOptionalParameters) (interface{}, *_nethttp.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		localVarReturnValue interface{}
		optionalParams      PatchAlertStrategyOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type PatchAlertStrategyOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
