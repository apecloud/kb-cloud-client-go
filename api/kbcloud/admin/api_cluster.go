...
func (a *ClusterApi) GetClusterStorageUsageHistory(ctx _context.Context, orgName string, clusterName string, o ...GetClusterStorageUsageHistoryOptionalParameters) (ClusterStorageUsageHistory, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/storageUsageHistory",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/storageUsageHistory"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *ClusterApi) GetInstanceContainerLog(ctx _context.Context, orgName string, clusterName string, instanceName string, o ...GetInstanceContainerLogOptionalParameters) (InstanceLog, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/instances/{instanceName}/log"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *ClusterApi) GetSqlAudit(ctx _context.Context, orgName string, clusterName string, component string) (SqlAuditStatus, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/sqlAudit"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *ClusterApi) GetTDE(ctx _context.Context, orgName string, clusterName string, component string) (TdeStatus, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/tde"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *ClusterApi) ListInstanceEvents(ctx _context.Context, orgName string, clusterName string, instanceName string, o ...ListInstanceEventsOptionalParameters) (InstanceEventList, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/instances/{instanceName}/events"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"instanceName"+"}", _neturl.PathEscape(common.ParameterToString(instanceName, "")), -1)
...
func (a *ClusterApi) ListOfflineInstance(ctx _context.Context, orgName string, clusterName string) (OfflineInstanceList, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/offlineInstances"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *ClusterApi) RestartInstance(ctx _context.Context, orgName string, clusterName string, instanceName string) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/instances/{instanceName}/restart"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"instanceName"+"}", _neturl.PathEscape(common.ParameterToString(instanceName, "")), -1)
...
func (a *ClusterApi) TransitionClusterMode(ctx _context.Context, orgName string, clusterName string, body ClusterModeTransition) (OpsRequestName, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/modeTransition",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/modeTransition"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *ClusterApi) ValidateClusterCreation(ctx _context.Context, orgName string, body ClusterCreate) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/validate"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
