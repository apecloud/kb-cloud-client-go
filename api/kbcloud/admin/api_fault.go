...
func (a *FaultApi) CreateClusterNetworkChaos(ctx _context.Context, body NetworkChaos) (Fault, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/fault/networkChaos"
...
func (a *FaultApi) CreateClusterPodChaos(ctx _context.Context, body PodChaos) (Fault, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/fault/podChaos"
...
func (a *FaultApi) DeleteFault(ctx _context.Context, body []string) (interface{}, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/fault"
...
func (a *FaultApi) GetChaos(ctx _context.Context, faultId int32) (Fault, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/fault/{faultId}"
	localVarPath = strings.Replace(localVarPath, "{"+"faultId"+"}", _neturl.PathEscape(common.ParameterToString(faultId, "")), -1)
...
func NewListFaultOptionalParameters() *ListFaultOptionalParameters {
...
// NewFaultApi Returns NewFaultApi.
func NewFaultApi(client *common.APIClient) *FaultApi {
	return &FaultApi{
		Client: client,
	}
}
