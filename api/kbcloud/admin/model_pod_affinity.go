...
// PodAffinity Rules for scheduling pods to co-locate with other pods.
...
func (o *PodAffinity) GetRequiredDuringSchedulingIgnoredDuringExecution() RequiredSchedulingRule {
...
func (o *PodAffinity) GetRequiredDuringSchedulingIgnoredDuringExecutionOk() (*RequiredSchedulingRule, bool) {
	if o == nil || o.RequiredDuringSchedulingIgnoredDuringExecution == nil {
		return nil, false
	}
...
func (o *PodAffinity) HasRequiredDuringSchedulingIgnoredDuringExecution() bool {
...
func (o *PodAffinity) SetRequiredDuringSchedulingIgnoredDuringExecution(v RequiredSchedulingRule) {
...
func (o *PodAffinity) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		RequiredDuringSchedulingIgnoredDuringExecution *RequiredSchedulingRule `json:"requiredDuringSchedulingIgnoredDuringExecution,omitempty"`
	}{}
