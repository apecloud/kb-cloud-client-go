...
// DatabaseParametersApi service type
type DatabaseParametersApi common.Service

// CreateDatabaseParameter Create database parameter.
func (a *DatabaseParametersApi) CreateDatabaseParameter(ctx _context.Context, body DatabaseParameterItem) (DatabaseParameterItem, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue DatabaseParameterItem
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "databaseParameters",
		OperationID: "createDatabaseParameter",
		Path:        "/admin/v1/databaseParameters",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DatabaseParametersApi.CreateDatabaseParameter")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/databaseParameters"
...
func (a *DatabaseParametersApi) DeleteDatabaseParameter(ctx _context.Context, body DatabaseParameterItem) (*_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		Tag:         "databaseParameters",
		OperationID: "deleteDatabaseParameter",
		Path:        "/admin/v1/databaseParameters",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DatabaseParametersApi.DeleteDatabaseParameter")
	if err != nil {
...
func (a *DatabaseParametersApi) ListDatabaseParameters(ctx _context.Context, o ...ListDatabaseParametersOptionalParameters) (DatabaseParameterList, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DatabaseParametersApi.ListDatabaseParameters")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// UpdateDatabaseParameter Update database parameter.
func (a *DatabaseParametersApi) UpdateDatabaseParameter(ctx _context.Context, body DatabaseParameterItem) (DatabaseParameterItem, *_nethttp.Response, error) {
	var (
	...
	apiInfo := common.APIInfo{
		Tag:         "databaseParameters",
		OperationID: "updateDatabaseParameter",
		Path:        "/admin/v1/databaseParameters",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DatabaseParametersApi.UpdateDatabaseParameter")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// NewDatabaseParametersApi Returns NewDatabaseParametersApi.
func NewDatabaseParametersApi(client *common.APIClient) *DatabaseParametersApi {
	return &DatabaseParametersApi{
		Client: client,
	}
}
