...
// LicenseApi service type
type LicenseApi common.Service
...
func (a *LicenseApi) GetLicense(ctx _context.Context) (License, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".LicenseApi.GetLicense")
	if err != nil {
...
func (a *LicenseApi) UpdateLicense(ctx _context.Context, body LicenseRequest) (License, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".LicenseApi.UpdateLicense")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// NewLicenseApi Returns NewLicenseApi.
func NewLicenseApi(client *common.APIClient) *LicenseApi {
	return &LicenseApi{
		Client: client,
	}
}
