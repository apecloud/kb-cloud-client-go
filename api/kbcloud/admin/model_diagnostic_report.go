...
func (o *DiagnosticReport) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = common.Unmarshal(bytes, &additionalProperties); err == nil {
		common.DeleteKeys(additionalProperties, &[]string{"taskId", "generatedAt", "overallStatus", "summary", "recommendedLayer", "ownerHint", "exportAvailable", "healthScore", "healthBucket", "topIssues", "timeline", "dbPerformance", "findings", "checks"})
	} else {
		return err
	}
