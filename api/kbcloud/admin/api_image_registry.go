...
// ImageRegistryApi service type
type ImageRegistryApi common.Service
...
func (a *ImageRegistryApi) CreateImageRegistry(ctx _context.Context, body ImageRegistry) (ImageRegistry, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/imageRegistries"
...
// DeleteImageRegistryOptionalParameters holds optional parameters for DeleteImageRegistry.
type DeleteImageRegistryOptionalParameters struct {
	Body *ImageRegistry
}

// NewDeleteImageRegistryOptionalParameters creates an empty struct for parameters.
func NewDeleteImageRegistryOptionalParameters() *DeleteImageRegistryOptionalParameters {
...
func (a *ImageRegistryApi) DeleteImageRegistry(ctx _context.Context, imageRegistryName string, o ...DeleteImageRegistryOptionalParameters) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/imageRegistries/{imageRegistryName}"
	localVarPath = strings.Replace(localVarPath, "{"+"imageRegistryName"+"}", _neturl.PathEscape(common.ParameterToString(imageRegistryName, "")), -1)
...
// NewImageRegistryApi Returns NewImageRegistryApi.
func NewImageRegistryApi(client *common.APIClient) *ImageRegistryApi {
