...
func NewDiagnosticDBPerformanceLongTransactionMetric(severity DiagnosticCheckSeverity, source string, dataQuality DiagnosticMetricDataQuality, reason string, longTransactionState DiagnosticDBPerformanceLongTransactionState) *DiagnosticDBPerformanceLongTransactionMetric {
...
func (o *DiagnosticDBPerformanceLongTransactionMetric) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = common.Unmarshal(bytes, &additionalProperties); err == nil {
		common.DeleteKeys(additionalProperties, &[]string{"value", "unit", "ratio", "threshold", "severity", "source", "dataQuality", "reasonCode", "reason", "longTransactionState", "datasetSummary", "collectionError"})
	} else {
		return err
	}
