...
func (o *MilvusAccountRoles) GetPrivilegesList() []PrivilegeListItem {
...
// and a boolean to check if the value has been set.
func (o *MilvusAccountRoles) GetPrivilegesListOk() (*[]PrivilegeListItem, bool) {
	if o == nil || o.PrivilegesList == nil {
		return nil, false
	}
...
func (o *MilvusAccountRoles) HasPrivilegesList() bool {
...
func (o *MilvusAccountRoles) SetPrivilegesList(v []PrivilegeListItem) {
	o.PrivilegesList = v
}
...
func (o *MilvusAccountRoles) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = common.Unmarshal(bytes, &additionalProperties); err == nil {
		common.DeleteKeys(additionalProperties, &[]string{"role", "roles", "privilegesList"})
	} else {
		return err
	}
	o.Role = all.Role
