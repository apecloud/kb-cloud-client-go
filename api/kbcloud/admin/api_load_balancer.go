...
// InstallLoadBalancer Install load balancer in the environment.
func (a *LoadBalancerApi) InstallLoadBalancer(ctx _context.Context, environmentName string, body LoadBalancerInstall) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPost
		localVarPostBody   interface{}
	)
	...
	localVarPath := localBasePath + "/admin/v1/environments/{environmentName}/loadbalancer/install"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentName"+"}", _neturl.PathEscape(common.ParameterToString(environmentName, "")), -1)
...
// UninstallLoadBalancer Uninstall load balancer in the environment.
func (a *LoadBalancerApi) UninstallLoadBalancer(ctx _context.Context, environmentName string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPost
		localVarPostBody   interface{}
	)
	...
	localVarPath := localBasePath + "/admin/v1/environments/{environmentName}/loadbalancer/uninstall"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentName"+"}", _neturl.PathEscape(common.ParameterToString(environmentName, "")), -1)
