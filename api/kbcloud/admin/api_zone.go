...
func (a *ZoneApi) CreateZone(ctx _context.Context, providerName string, regionName string, body ZoneCreate) (Zone, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/providers/{providerName}/regions/{regionName}/zones"
...
func (a *ZoneApi) DeleteZone(ctx _context.Context, providerName string, regionName string, zoneName string) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/providers/{providerName}/regions/{regionName}/zones/{zoneName}"
	localVarPath = strings.Replace(localVarPath, "{"+"providerName"+"}", _neturl.PathEscape(common.ParameterToString(providerName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"regionName"+"}", _neturl.PathEscape(common.ParameterToString(regionName, "")), -1)
