...
// RelationApi service type
type RelationApi common.Service

// CreateRelation create a relation between the clusters in the organization.
func (a *RelationApi) CreateRelation(ctx _context.Context, orgName string, clusterName string, target string) (*_nethttp.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/relations"
	...
	localVarQueryParams.Add("target", common.ParameterToString(target, ""))
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 401 || localVarHTTPResponse.StatusCode == 403 || localVarHTTPResponse.StatusCode == 404 || localVarHTTPResponse.StatusCode == 500 || localVarHTTPResponse.StatusCode == 503 {
...
// DeleteRelation delete a existed relation between the clusters in the organization.
func (a *RelationApi) DeleteRelation(ctx _context.Context, orgName string, clusterName string, target string) (*_nethttp.Response, error) {
	var (
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/relation/{target}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"target"+"}", _neturl.PathEscape(common.ParameterToString(target, "")), -1)
...
func (a *RelationApi) ListAvailableClustersForRelation(ctx _context.Context, orgName string, clusterName string, targetType string) ([]AvailableClusterListItem, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/cluster/{clusterName}/available-relations"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	localVarQueryParams.Add("targetType", common.ParameterToString(targetType, ""))
...
// NewRelationApi Returns NewRelationApi.
func NewRelationApi(client *common.APIClient) *RelationApi {
	return &RelationApi{
		Client: client,
	}
}
