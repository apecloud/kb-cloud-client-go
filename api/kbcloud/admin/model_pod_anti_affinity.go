...
// PodAntiAffinity Rules for scheduling pods to avoid co-locating with other pods.
...
func (o *PodAntiAffinity) GetRequiredDuringSchedulingIgnoredDuringExecution() RequiredSchedulingRule {
...
func (o *PodAntiAffinity) GetRequiredDuringSchedulingIgnoredDuringExecutionOk() (*RequiredSchedulingRule, bool) {
	if o == nil || o.RequiredDuringSchedulingIgnoredDuringExecution == nil {
		return nil, false
	}
...
func (o *PodAntiAffinity) HasRequiredDuringSchedulingIgnoredDuringExecution() bool {
...
func (o *PodAntiAffinity) SetRequiredDuringSchedulingIgnoredDuringExecution(v RequiredSchedulingRule) {
...
func (o *PodAntiAffinity) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		RequiredDuringSchedulingIgnoredDuringExecution *RequiredSchedulingRule `json:"requiredDuringSchedulingIgnoredDuringExecution,omitempty"`
	}{}
