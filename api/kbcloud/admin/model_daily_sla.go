...
func (o *DailySLA) GetSla() float64 {
...
func (o *DailySLA) GetSlaOk() (*float64, bool) {
	if o == nil {
		return nil, false
	}
...
// SetSla gets a reference to the given common.NullableFloat64 and assigns it to the Sla field.
func (o *DailySLA) SetSla(v float64) {
	o.Sla.Set(&v)
}
