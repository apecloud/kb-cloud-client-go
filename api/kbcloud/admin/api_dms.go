...
func NewDataExportOptionalParameters() *DataExportOptionalParameters {
	this := DataExportOptionalParameters{}
	return &this
}
...
func (a *DmsApi) DataExport(ctx _context.Context, orgName string, clusterName string, id string, o ...DataExportOptionalParameters) (*_nethttp.Response, error) {
	var (
		...
		optionalParams     DataExportOptionalParameters
	)

	if len(o) > 1 {
		return nil, common.ReportError("only one argument of type DataExportOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/export"
...
func (a *DmsApi) DataImport(ctx _context.Context, orgName string, clusterName string, id string, body DmsImportRequest, file _io.Reader) (interface{}, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/import",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/import"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
func (a *DmsApi) GetObjectInfo(ctx _context.Context, orgName string, clusterName string, id string, schema string, typeVar string, objectName string, o ...GetObjectInfoOptionalParameters) (DmsObjectResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/{schema}/{type}/{objectName}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	...
	localVarPath = strings.Replace(localVarPath, "{"+"objectName"+"}", _neturl.PathEscape(common.ParameterToString(objectName, "")), -1)
...
func (a *DmsApi) GetTaskList(ctx _context.Context, orgName string, clusterName string, id string) (DmsTaskList, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/tasks"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
func (a *DmsApi) GetTaskProgress(ctx _context.Context, orgName string, clusterName string, id string, taskId string) (DmsTaskInfo, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/task"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	localVarQueryParams.Add("taskId", common.ParameterToString(taskId, ""))
	localVarHeaderParams["Accept"] = "application/json"
...
func (a *DmsApi) ListObjectNamesByType(ctx _context.Context, orgName string, clusterName string, id string, schema string, typeVar string, o ...ListObjectNamesByTypeOptionalParameters) ([]string, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/{schema}/{type}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"schema"+"}", _neturl.PathEscape(common.ParameterToString(schema, "")), -1)
...
func (a *DmsApi) ListObjectTypesInSchema(ctx _context.Context, orgName string, clusterName string, id string, schema string, o ...ListObjectTypesInSchemaOptionalParameters) ([]DmsObject, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/{schema}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"schema"+"}", _neturl.PathEscape(common.ParameterToString(schema, "")), -1)
...
func (a *DmsApi) AlterParameter(ctx _context.Context, orgName string, clusterName string, tenantId string, body DmsObAlterParameter) (string, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/tenant/{tenantId}/parameter"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
// AnalyzeRedisKeysOptionalParameters holds optional parameters for AnalyzeRedisKeys.
type AnalyzeRedisKeysOptionalParameters struct {
	Database           *int64
	Match              *string
	Cursor             *string
	SampleLimit        *int64
...
// NewAnalyzeRedisKeysOptionalParameters creates an empty struct for parameters.
func NewAnalyzeRedisKeysOptionalParameters() *AnalyzeRedisKeysOptionalParameters {
	this := AnalyzeRedisKeysOptionalParameters{}
	return &this
}

// WithDatabase sets the corresponding parameter name and returns the struct.
func (r *AnalyzeRedisKeysOptionalParameters) WithDatabase(database int64) *AnalyzeRedisKeysOptionalParameters {
	r.Database = &database
	return r
}

// WithMatch sets the corresponding parameter name and returns the struct.
func (r *AnalyzeRedisKeysOptionalParameters) WithMatch(match string) *AnalyzeRedisKeysOptionalParameters {
	r.Match = &match
	return r
}

// WithCursor sets the corresponding parameter name and returns the struct.
func (r *AnalyzeRedisKeysOptionalParameters) WithCursor(cursor string) *AnalyzeRedisKeysOptionalParameters {
	r.Cursor = &cursor
	return r
}

// WithSampleLimit sets the corresponding parameter name and returns the struct.
func (r *AnalyzeRedisKeysOptionalParameters) WithSampleLimit(sampleLimit int64) *AnalyzeRedisKeysOptionalParameters {
	r.SampleLimit = &sampleLimit
	return r
}

// WithTopN sets the corresponding parameter name and returns the struct.
func (r *AnalyzeRedisKeysOptionalParameters) WithTopN(topN int64) *AnalyzeRedisKeysOptionalParameters {
	r.TopN = &topN
	return r
}

// WithNamespaceSeparator sets the corresponding parameter name and returns the struct.
func (r *AnalyzeRedisKeysOptionalParameters) WithNamespaceSeparator(namespaceSeparator string) *AnalyzeRedisKeysOptionalParameters {
	r.NamespaceSeparator = &namespaceSeparator
	return r
}

// AnalyzeRedisKeys analyze Redis keys by bounded SCAN sampling.
...
func (a *DmsApi) AnalyzeRedisKeys(ctx _context.Context, orgName string, clusterName string, id string, o ...AnalyzeRedisKeysOptionalParameters) (RedisAnalysisResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue RedisAnalysisResponse
		optionalParams      AnalyzeRedisKeysOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type AnalyzeRedisKeysOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/analysis",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.AnalyzeRedisKeys")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/analysis"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	...
	if optionalParams.Match != nil {
		localVarQueryParams.Add("match", common.ParameterToString(*optionalParams.Match, ""))
	}
	if optionalParams.Cursor != nil {
		localVarQueryParams.Add("cursor", common.ParameterToString(*optionalParams.Cursor, ""))
	}
	if optionalParams.SampleLimit != nil {
		localVarQueryParams.Add("sampleLimit", common.ParameterToString(*optionalParams.SampleLimit, ""))
	}
	if optionalParams.TopN != nil {
		localVarQueryParams.Add("topN", common.ParameterToString(*optionalParams.TopN, ""))
	}
	if optionalParams.NamespaceSeparator != nil {
		localVarQueryParams.Add("namespaceSeparator", common.ParameterToString(*optionalParams.NamespaceSeparator, ""))
	}
	localVarHeaderParams["Accept"] = "application/json"
...
func (a *DmsApi) CloseRedisPubSubSession(ctx _context.Context, orgName string, clusterName string, id string, sessionId string) (*_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/pubsub/sessions/{sessionId}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/pubsub/sessions/{sessionId}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
func NewCloseSessionsOptionalParameters() *CloseSessionsOptionalParameters {
	this := CloseSessionsOptionalParameters{}
	return &this
}

// WithKeep sets the corresponding parameter name and returns the struct.
func (r *CloseSessionsOptionalParameters) WithKeep(keep string) *CloseSessionsOptionalParameters {
	r.Keep = &keep
	return r
}
...
func (a *DmsApi) CloseSessions(ctx _context.Context, orgName string, clusterName string, session string, o ...CloseSessionsOptionalParameters) (string, *_nethttp.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		localVarReturnValue string
		optionalParams      CloseSessionsOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type CloseSessionsOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/session/{session}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *DmsApi) CreateDataSourceV2(ctx _context.Context, orgName string, clusterName string, body Datasource) (Datasource, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/createDS",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
...
func (a *DmsApi) CreateRedisPubSubSession(ctx _context.Context, orgName string, clusterName string, id string, body RedisPubSubSessionCreateRequest, o ...CreateRedisPubSubSessionOptionalParameters) (RedisPubSubSession, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/pubsub/sessions",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/pubsub/sessions"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
func (a *DmsApi) DeleteDataSourceV2(ctx _context.Context, orgName string, clusterName string, id string) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
// disable console
func (a *DmsApi) DisableConsole(ctx _context.Context, engineName string, orgName string, clusterName string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.DisableConsole")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/data/{engineName}/organizations/{orgName}/clusters/{clusterName}/console"
...
// DropMongoCollection drop a MongoDB collection or view.
func (a *DmsApi) DropMongoCollection(ctx _context.Context, orgName string, clusterName string, id string, db string, col string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)
	...
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "dropMongoCollection",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.DropMongoCollection")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"db"+"}", _neturl.PathEscape(common.ParameterToString(db, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"col"+"}", _neturl.PathEscape(common.ParameterToString(col, "")), -1)
...
// EnableConsoleOptionalParameters holds optional parameters for EnableConsole.
type EnableConsoleOptionalParameters struct {
	Body *DMSConsoleEnableOpt
}

// NewEnableConsoleOptionalParameters creates an empty struct for parameters.
func NewEnableConsoleOptionalParameters() *EnableConsoleOptionalParameters {
	this := EnableConsoleOptionalParameters{}
	return &this
}

// WithBody sets the corresponding parameter name and returns the struct.
func (r *EnableConsoleOptionalParameters) WithBody(body DMSConsoleEnableOpt) *EnableConsoleOptionalParameters {
	r.Body = &body
	return r
}
...
func (a *DmsApi) EnableConsole(ctx _context.Context, engineName string, orgName string, clusterName string, o ...EnableConsoleOptionalParameters) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPost
		localVarPostBody   interface{}
		optionalParams     EnableConsoleOptionalParameters
	)

	if len(o) > 1 {
		return nil, common.ReportError("only one argument of type EnableConsoleOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.EnableConsole")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *DmsApi) ExecuteRedisWorkbenchCommand(ctx _context.Context, orgName string, clusterName string, id string, body RedisWorkbenchExecuteRequest, o ...ExecuteRedisWorkbenchCommandOptionalParameters) (RedisWorkbenchExecuteResponse, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/workbench/execute",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/workbench/execute"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
func NewGenerateDDLOptionalParameters() *GenerateDDLOptionalParameters {
	this := GenerateDDLOptionalParameters{}
	return &this
}
...
func (a *DmsApi) GenerateDDL(ctx _context.Context, orgName string, clusterName string, id string, o ...GenerateDDLOptionalParameters) (string, *_nethttp.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		localVarReturnValue string
		optionalParams      GenerateDDLOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type GenerateDDLOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/generateDDL",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/generateDDL"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
// GetEngineAvailableConsole get engine available console.
// get engine available console
func (a *DmsApi) GetEngineAvailableConsole(ctx _context.Context, engineName string, orgName string, clusterName string) (Console, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue Console
	)
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.GetEngineAvailableConsole")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// GetMongoCollection get MongoDB collection stats.
func (a *DmsApi) GetMongoCollection(ctx _context.Context, orgName string, clusterName string, id string, db string, col string) (MongoCollectionStats, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue MongoCollectionStats
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "getMongoCollection",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.GetMongoCollection")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *DmsApi) GetRedisClusterTopology(ctx _context.Context, orgName string, clusterName string, id string, o ...GetRedisClusterTopologyOptionalParameters) (RedisClusterTopology, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/cluster/topology",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/cluster/topology"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
func (a *DmsApi) GetRedisContext(ctx _context.Context, orgName string, clusterName string, id string, o ...GetRedisContextOptionalParameters) (RedisDataContext, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/context",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/context"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
func (a *DmsApi) GetRedisInfo(ctx _context.Context, orgName string, clusterName string, id string, o ...GetRedisInfoOptionalParameters) (RedisInfoResponse, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/info",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/info"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
func (a *DmsApi) GetRedisKeyDetail(ctx _context.Context, orgName string, clusterName string, id string, body RedisKeyDetailRequest, o ...GetRedisKeyDetailOptionalParameters) (RedisKeyDetail, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/key/detail",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/key/detail"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
func (a *DmsApi) GetSchemaList(ctx _context.Context, orgName string, clusterName string, id string, o ...GetSchemaListOptionalParameters) ([]string, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/schemas"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
// ListMongoCollections list collections in a MongoDB database.
func (a *DmsApi) ListMongoCollections(ctx _context.Context, orgName string, clusterName string, id string, db string) ([]MongoCollectionInfo, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue []MongoCollectionInfo
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "listMongoCollections",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.ListMongoCollections")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"db"+"}", _neturl.PathEscape(common.ParameterToString(db, "")), -1)
...
// ListMongoDatabaseMetadata list MongoDB database metadata.
func (a *DmsApi) ListMongoDatabaseMetadata(ctx _context.Context, orgName string, clusterName string, id string) ([]MongoDatabaseInfo, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue []MongoDatabaseInfo
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "listMongoDatabaseMetadata",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/metadata",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.ListMongoDatabaseMetadata")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/metadata"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
// ListMongoDatabases list MongoDB databases.
func (a *DmsApi) ListMongoDatabases(ctx _context.Context, orgName string, clusterName string, id string) ([]string, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue []string
	...
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "listMongoDatabases",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.ListMongoDatabases")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
func (a *DmsApi) ListParameters(ctx _context.Context, orgName string, clusterName string, tenantId string, mode string) ([]DmsObParameter, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/tenant/{tenantId}/parameters"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"tenantId"+"}", _neturl.PathEscape(common.ParameterToString(tenantId, "")), -1)
...
func (a *DmsApi) ListQueryHistory(ctx _context.Context, orgName string, clusterName string, id string, o ...ListQueryHistoryOptionalParameters) ([]DmsQueryHistory, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/history"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
func (a *DmsApi) ListRedisKeys(ctx _context.Context, orgName string, clusterName string, id string, o ...ListRedisKeysOptionalParameters) (RedisKeySummaryList, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/keys",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/keys"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
func (a *DmsApi) ListRedisPubSubMessages(ctx _context.Context, orgName string, clusterName string, id string, sessionId string, o ...ListRedisPubSubMessagesOptionalParameters) (RedisPubSubMessageList, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/pubsub/sessions/{sessionId}/messages",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/pubsub/sessions/{sessionId}/messages"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"sessionId"+"}", _neturl.PathEscape(common.ParameterToString(sessionId, "")), -1)
...
func (a *DmsApi) ListRedisSlowLog(ctx _context.Context, orgName string, clusterName string, id string, o ...ListRedisSlowLogOptionalParameters) (RedisSlowLogList, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/slowlog",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/slowlog"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
func (a *DmsApi) ListSessionsOld(ctx _context.Context, orgName string, clusterName string, o ...ListSessionsOldOptionalParameters) ([]DmsSession, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/sessions"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
// MongoAggregate run MongoDB aggregation pipeline preview.
func (a *DmsApi) MongoAggregate(ctx _context.Context, orgName string, clusterName string, id string, db string, col string, body MongoAggregateRequest) (MongoFindResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue MongoFindResponse
	)
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoAggregate")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/aggregate"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"db"+"}", _neturl.PathEscape(common.ParameterToString(db, "")), -1)
...
// MongoAnalyzeSchemaOptionalParameters holds optional parameters for MongoAnalyzeSchema.
type MongoAnalyzeSchemaOptionalParameters struct {
	Sample *int64
}

// NewMongoAnalyzeSchemaOptionalParameters creates an empty struct for parameters.
func NewMongoAnalyzeSchemaOptionalParameters() *MongoAnalyzeSchemaOptionalParameters {
	this := MongoAnalyzeSchemaOptionalParameters{}
	return &this
}

// WithSample sets the corresponding parameter name and returns the struct.
func (r *MongoAnalyzeSchemaOptionalParameters) WithSample(sample int64) *MongoAnalyzeSchemaOptionalParameters {
	r.Sample = &sample
	return r
}

// MongoAnalyzeSchema analyze MongoDB collection schema from sample documents.
func (a *DmsApi) MongoAnalyzeSchema(ctx _context.Context, orgName string, clusterName string, id string, db string, col string, o ...MongoAnalyzeSchemaOptionalParameters) (MongoSchemaAnalysis, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue MongoSchemaAnalysis
		optionalParams      MongoAnalyzeSchemaOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type MongoAnalyzeSchemaOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "mongoAnalyzeSchema",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/schema",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoAnalyzeSchema")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/schema"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"db"+"}", _neturl.PathEscape(common.ParameterToString(db, "")), -1)
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if optionalParams.Sample != nil {
		localVarQueryParams.Add("sample", common.ParameterToString(*optionalParams.Sample, ""))
	}
	localVarHeaderParams["Accept"] = "application/json"
...
// MongoCloseShellSession close MongoDB mongosh runtime session.
func (a *DmsApi) MongoCloseShellSession(ctx _context.Context, orgName string, clusterName string, id string, sessionId string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)
	...
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "mongoCloseShellSession",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/shell/sessions/{sessionID}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoCloseShellSession")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/shell/sessions/{sessionID}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"sessionID"+"}", _neturl.PathEscape(common.ParameterToString(sessionId, "")), -1)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 404 || localVarHTTPResponse.StatusCode == 500 {
			var v APIErrorResponse
			err = a.Client.Decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				return localVarHTTPResponse, newErr
...
// MongoCompleteShell get completions for a MongoDB mongosh session.
func (a *DmsApi) MongoCompleteShell(ctx _context.Context, orgName string, clusterName string, id string, sessionId string, body MongoShellCompletionsRequest) (MongoShellCompletionsResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue MongoShellCompletionsResponse
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "mongoCompleteShell",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/shell/sessions/{sessionID}/completions",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoCompleteShell")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/shell/sessions/{sessionID}/completions"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"sessionID"+"}", _neturl.PathEscape(common.ParameterToString(sessionId, "")), -1)
...
// MongoCreateCollectionOptionalParameters holds optional parameters for MongoCreateCollection.
type MongoCreateCollectionOptionalParameters struct {
	Body *MongoCreateCollectionRequest
}

// NewMongoCreateCollectionOptionalParameters creates an empty struct for parameters.
func NewMongoCreateCollectionOptionalParameters() *MongoCreateCollectionOptionalParameters {
	this := MongoCreateCollectionOptionalParameters{}
	return &this
}

// WithBody sets the corresponding parameter name and returns the struct.
func (r *MongoCreateCollectionOptionalParameters) WithBody(body MongoCreateCollectionRequest) *MongoCreateCollectionOptionalParameters {
	r.Body = &body
	return r
}
...
func (a *DmsApi) MongoCreateCollection(ctx _context.Context, orgName string, clusterName string, id string, db string, col string, o ...MongoCreateCollectionOptionalParameters) (MongoCollectionInfo, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue MongoCollectionInfo
		optionalParams      MongoCreateCollectionOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type MongoCreateCollectionOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "mongoCreateCollection",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoCreateCollection")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// MongoCreateIndex create MongoDB collection index.
func (a *DmsApi) MongoCreateIndex(ctx _context.Context, orgName string, clusterName string, id string, db string, col string, body MongoCreateIndexRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPost
		localVarPostBody   interface{}
	)
	...
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "mongoCreateIndex",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/indexes",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoCreateIndex")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/indexes"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"db"+"}", _neturl.PathEscape(common.ParameterToString(db, "")), -1)
...
// MongoCreateShellSessionOptionalParameters holds optional parameters for MongoCreateShellSession.
type MongoCreateShellSessionOptionalParameters struct {
	Body *MongoShellCreateSessionRequest
}

// NewMongoCreateShellSessionOptionalParameters creates an empty struct for parameters.
func NewMongoCreateShellSessionOptionalParameters() *MongoCreateShellSessionOptionalParameters {
	this := MongoCreateShellSessionOptionalParameters{}
	return &this
}

// WithBody sets the corresponding parameter name and returns the struct.
func (r *MongoCreateShellSessionOptionalParameters) WithBody(body MongoShellCreateSessionRequest) *MongoCreateShellSessionOptionalParameters {
	r.Body = &body
	return r
}

// MongoCreateShellSession create MongoDB mongosh runtime session.
func (a *DmsApi) MongoCreateShellSession(ctx _context.Context, orgName string, clusterName string, id string, o ...MongoCreateShellSessionOptionalParameters) (MongoShellSession, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue MongoShellSession
		optionalParams      MongoCreateShellSessionOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type MongoCreateShellSessionOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "mongoCreateShellSession",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/shell/sessions",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoCreateShellSession")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/shell/sessions"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 || localVarHTTPResponse.StatusCode == 401 || localVarHTTPResponse.StatusCode == 403 || localVarHTTPResponse.StatusCode == 404 || localVarHTTPResponse.StatusCode == 500 || localVarHTTPResponse.StatusCode == 503 {
			var v APIErrorResponse
			err = a.Client.Decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				return localVarReturnValue, localVarHTTPResponse, newErr
...
// MongoCreateView create MongoDB view from a read-only aggregation pipeline.
func (a *DmsApi) MongoCreateView(ctx _context.Context, orgName string, clusterName string, id string, db string, body MongoCreateViewRequest) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPost
		localVarPostBody   interface{}
	)
	...
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "mongoCreateView",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/views",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoCreateView")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/views"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"db"+"}", _neturl.PathEscape(common.ParameterToString(db, "")), -1)
...
// MongoDelete delete a single MongoDB document.
func (a *DmsApi) MongoDelete(ctx _context.Context, orgName string, clusterName string, id string, db string, col string, body MongoDeleteRequest) (MongoWriteResult, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue MongoWriteResult
	)
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/delete",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoDelete")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/delete"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"db"+"}", _neturl.PathEscape(common.ParameterToString(db, "")), -1)
...
// MongoDropIndex drop MongoDB collection index.
func (a *DmsApi) MongoDropIndex(ctx _context.Context, orgName string, clusterName string, id string, db string, col string, indexName string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)
	...
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "mongoDropIndex",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/indexes/{indexName}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoDropIndex")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/indexes/{indexName}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"db"+"}", _neturl.PathEscape(common.ParameterToString(db, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"col"+"}", _neturl.PathEscape(common.ParameterToString(col, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"indexName"+"}", _neturl.PathEscape(common.ParameterToString(indexName, "")), -1)
...
// MongoEvaluateShell evaluate input in a MongoDB mongosh session.
func (a *DmsApi) MongoEvaluateShell(ctx _context.Context, orgName string, clusterName string, id string, sessionId string, body MongoShellEvaluateRequest) (MongoShellEvaluateResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue MongoShellEvaluateResponse
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "mongoEvaluateShell",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/shell/sessions/{sessionID}/evaluate",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoEvaluateShell")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/shell/sessions/{sessionID}/evaluate"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"sessionID"+"}", _neturl.PathEscape(common.ParameterToString(sessionId, "")), -1)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 || localVarHTTPResponse.StatusCode == 404 || localVarHTTPResponse.StatusCode == 500 || localVarHTTPResponse.StatusCode == 504 {
			var v APIErrorResponse
			err = a.Client.Decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				return localVarReturnValue, localVarHTTPResponse, newErr
...
// MongoExplain explain a MongoDB query.
func (a *DmsApi) MongoExplain(ctx _context.Context, orgName string, clusterName string, id string, body MongoExplainRequest) (MongoExplainResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue MongoExplainResponse
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "mongoExplain",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/explain",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoExplain")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/explain"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
// MongoFind find documents in a MongoDB collection.
func (a *DmsApi) MongoFind(ctx _context.Context, orgName string, clusterName string, id string, db string, col string, body MongoFindRequest) (MongoFindResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue MongoFindResponse
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoFind")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/find"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"db"+"}", _neturl.PathEscape(common.ParameterToString(db, "")), -1)
...
// MongoGetShellPrompt get MongoDB mongosh session prompt.
func (a *DmsApi) MongoGetShellPrompt(ctx _context.Context, orgName string, clusterName string, id string, sessionId string) (MongoShellPromptResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue MongoShellPromptResponse
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "mongoGetShellPrompt",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/shell/sessions/{sessionID}/prompt",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoGetShellPrompt")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/shell/sessions/{sessionID}/prompt"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"sessionID"+"}", _neturl.PathEscape(common.ParameterToString(sessionId, "")), -1)
...
// MongoGetValidation get MongoDB collection validation options.
func (a *DmsApi) MongoGetValidation(ctx _context.Context, orgName string, clusterName string, id string, db string, col string) (MongoValidationInfo, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue MongoValidationInfo
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "mongoGetValidation",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/validation",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoGetValidation")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/validation"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"db"+"}", _neturl.PathEscape(common.ParameterToString(db, "")), -1)
...
// MongoInsert insert MongoDB document(s).
func (a *DmsApi) MongoInsert(ctx _context.Context, orgName string, clusterName string, id string, db string, col string, body MongoInsertRequest) (MongoWriteResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue MongoWriteResponse
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "mongoInsert",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/insert",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoInsert")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/insert"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"db"+"}", _neturl.PathEscape(common.ParameterToString(db, "")), -1)
...
// MongoInterruptShell interrupt current MongoDB mongosh session operation.
func (a *DmsApi) MongoInterruptShell(ctx _context.Context, orgName string, clusterName string, id string, sessionId string) (MongoShellInterruptResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue MongoShellInterruptResponse
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "mongoInterruptShell",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/shell/sessions/{sessionID}/interrupt",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoInterruptShell")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/shell/sessions/{sessionID}/interrupt"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"sessionID"+"}", _neturl.PathEscape(common.ParameterToString(sessionId, "")), -1)
...
// MongoListIndexes list MongoDB collection indexes.
func (a *DmsApi) MongoListIndexes(ctx _context.Context, orgName string, clusterName string, id string, db string, col string) ([]MongoIndexInfo, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue []MongoIndexInfo
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "mongoListIndexes",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/indexes",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoListIndexes")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// MongoReplace replace a single MongoDB document.
func (a *DmsApi) MongoReplace(ctx _context.Context, orgName string, clusterName string, id string, db string, col string, body MongoReplaceRequest) (MongoWriteResult, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue MongoWriteResult
	...
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "mongoReplace",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/replace",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoReplace")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/replace"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"db"+"}", _neturl.PathEscape(common.ParameterToString(db, "")), -1)
...
// MongoSetValidation set MongoDB collection validation options.
func (a *DmsApi) MongoSetValidation(ctx _context.Context, orgName string, clusterName string, id string, db string, col string, body MongoSetValidationRequest) (*_nethttp.Response, error) {
	var (
	...
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "mongoSetValidation",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/validation",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoSetValidation")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// MongoUpdate update a single MongoDB document.
func (a *DmsApi) MongoUpdate(ctx _context.Context, orgName string, clusterName string, id string, db string, col string, body MongoUpdateRequest) (MongoWriteResult, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue MongoWriteResult
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/update",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.MongoUpdate")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/mongodb/databases/{db}/collections/{col}/update"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"db"+"}", _neturl.PathEscape(common.ParameterToString(db, "")), -1)
...
func (a *DmsApi) MutateRedisKey(ctx _context.Context, orgName string, clusterName string, id string, body RedisKeyMutateRequest, o ...MutateRedisKeyOptionalParameters) (RedisKeyMutateResponse, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/key/mutate",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/key/mutate"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
func (a *DmsApi) PublishRedisMessage(ctx _context.Context, orgName string, clusterName string, id string, body RedisPubSubPublishRequest, o ...PublishRedisMessageOptionalParameters) (RedisOperationSummary, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/pubsub/publish",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/pubsub/publish"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
func (a *DmsApi) Query(ctx _context.Context, orgName string, clusterName string, id string, body DmsQueryRequest) (DmsQueryResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/query"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
func (a *DmsApi) ResetRedisSlowLog(ctx _context.Context, orgName string, clusterName string, id string, o ...ResetRedisSlowLogOptionalParameters) (RedisOperationSummary, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/slowlog/reset",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/redis/slowlog/reset"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
func (a *DmsApi) ShowData(ctx _context.Context, orgName string, clusterName string, id string, body ShowDataRequest) (DmsResult, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/showData"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
func (a *DmsApi) SqlExplain(ctx _context.Context, orgName string, clusterName string, id string, body DmsExplainRequest) (DmsQueryResponse, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/sqlExplain",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/sqlExplain"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
...
func NewTenantParameterHistoryOptionalParameters() *TenantParameterHistoryOptionalParameters {
	this := TenantParameterHistoryOptionalParameters{}
	return &this
}

// WithParameterName sets the corresponding parameter name and returns the struct.
func (r *TenantParameterHistoryOptionalParameters) WithParameterName(parameterName string) *TenantParameterHistoryOptionalParameters {
...
func (a *DmsApi) TenantParameterHistory(ctx _context.Context, orgName string, clusterName string, tenantId string, o ...TenantParameterHistoryOptionalParameters) (ParameterHistoryList, *_nethttp.Response, error) {
	var (
		...
		optionalParams      TenantParameterHistoryOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type TenantParameterHistoryOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/tenant/{tenantId}/parameterHistory"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"tenantId"+"}", _neturl.PathEscape(common.ParameterToString(tenantId, "")), -1)
...
func (a *DmsApi) TestDataSourceV2(ctx _context.Context, orgName string, clusterName string, body Datasource) (TestConnectResponse, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/testDS"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *DmsApi) UpdateDataSourceV2(ctx _context.Context, orgName string, clusterName string, body Datasource) (Datasource, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/updateDS",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
...
// VisualSqlExplain explain a SQL as a normalized visual execution plan.
func (a *DmsApi) VisualSqlExplain(ctx _context.Context, orgName string, clusterName string, id string, body DmsVisualExplainRequest) (DmsExecutionPlanResult, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue DmsExecutionPlanResult
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "dms",
		OperationID: "visualSqlExplain",
		Path:        "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/sqlExplain/visual",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DmsApi.VisualSqlExplain")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/admin/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/sqlExplain/visual"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
