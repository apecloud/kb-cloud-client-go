...
func (a *EngineLicenseApi) CreateEngineLicense(ctx _context.Context, name string, engineName string, typeVar string, o ...CreateEngineLicenseOptionalParameters) (EngineLicense, *_nethttp.Response, error) {
	...
	localVarFormParams.Add("name", common.ParameterToString(name, ""))

	localVarFormParams.Add("engineName", common.ParameterToString(engineName, ""))

	if optionalParams.Description != nil {
		localVarFormParams.Add("description", common.ParameterToString(*optionalParams.Description, ""))
	}

	if optionalParams.ExpiredAt != nil {
		localVarFormParams.Add("expiredAt", common.ParameterToString(*optionalParams.ExpiredAt, ""))
	}

	if optionalParams.EnvironmentId != nil {
		localVarFormParams.Add("environmentID", common.ParameterToString(*optionalParams.EnvironmentId, ""))
	}

	localVarFormParams.Add("type", common.ParameterToString(typeVar, ""))
	formFile := common.FormFile{}
	formFile.FormFileName = "licenseFile"
	var localVarFile _io.Reader
	if optionalParams.LicenseFile != nil {
		localVarFile = *optionalParams.LicenseFile
	}
	if localVarFile != nil {
...
func (a *EngineLicenseApi) DeleteEngineLicense(ctx _context.Context, licenseId string) (*_nethttp.Response, error) {
	var (
...
func (a *EngineLicenseApi) EngineLicense(ctx _context.Context, licenseId string) (EngineLicense, *_nethttp.Response, error) {
	var (
