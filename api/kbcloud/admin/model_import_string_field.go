...
func (o *ImportStringField) GetLabel() string {
...
// and a boolean to check if the value has been set.
func (o *ImportStringField) GetLabelOk() (*string, bool) {
	if o == nil || o.Label == nil {
		return nil, false
	}
	return &o.Label, true
...
func (o *ImportStringField) SetLabel(v string) {
	o.Label = v
}
...
func (o *ImportStringField) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *ImportStringField) GetDescriptionOk() (*string, bool) {
	if o == nil || o.Description == nil {
		return nil, false
	}
...
func (o *ImportStringField) SetDescription(v string) {
	o.Description = &v
}
