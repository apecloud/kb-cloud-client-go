...
func NewDiagnosticDBPerformanceLockWaitSample(blockedPid int64, blockingPid int64, waitDurationSeconds int64, lockType string, lockObject string, blockedQueryDigest string, blockingQueryDigest string) *DiagnosticDBPerformanceLockWaitSample {
...
func (o *DiagnosticDBPerformanceLockWaitSample) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = common.Unmarshal(bytes, &additionalProperties); err == nil {
		common.DeleteKeys(additionalProperties, &[]string{"blockedPid", "blockingPid", "blockedUser", "blockingUser", "databaseName", "waitDurationSeconds", "waitEventType", "waitEvent", "lockType", "lockMode", "lockObject", "blockedQueryDigest", "blockingQueryDigest"})
	} else {
		return err
	}
