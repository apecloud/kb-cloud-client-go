...
func (a *AIApi) AnalyzeCluster(ctx _context.Context) (interface{}, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/clusters/{clusterName}/analyze",
		Version:     "",
	}
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/analyze"
...
func (a *AIApi) ChatBIV2SSE(ctx _context.Context, body ChatRequest) (interface{}, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/ai/chatbiv2",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".AIApi.ChatBIV2SSE")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/ai/chatbiv2"
...
func (a *AIApi) ChatV2SSE(ctx _context.Context, body ChatRequest) (interface{}, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".AIApi.ChatV2SSE")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *AIApi) DeleteConversation(ctx _context.Context, conversationId uuid.UUID) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/ai/conversations/{conversationId}"
...
func (a *AIApi) GetConversationMessages(ctx _context.Context, conversationId uuid.UUID, o ...GetConversationMessagesOptionalParameters) (AiMessageListResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue AiMessageListResponse
	...
	localVarPath := localBasePath + "/api/v1/ai/conversations/{conversationId}/messages"
	localVarPath = strings.Replace(localVarPath, "{"+"conversationId"+"}", _neturl.PathEscape(common.ParameterToString(conversationId, "")), -1)
...
func (a *AIApi) ListConversations(ctx _context.Context, o ...ListConversationsOptionalParameters) (AiConversationListResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue AiConversationListResponse
	...
	localVarPath := localBasePath + "/api/v1/ai/conversations"
