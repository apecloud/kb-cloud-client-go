...
// CreateDatasetOptionalParameters holds optional parameters for CreateDataset.
type CreateDatasetOptionalParameters struct {
	Body *interface{}
}

// NewCreateDatasetOptionalParameters creates an empty struct for parameters.
func NewCreateDatasetOptionalParameters() *CreateDatasetOptionalParameters {
	this := CreateDatasetOptionalParameters{}
	return &this
}

// WithBody sets the corresponding parameter name and returns the struct.
func (r *CreateDatasetOptionalParameters) WithBody(body interface{}) *CreateDatasetOptionalParameters {
	r.Body = &body
	return r
}
...
func (a *DatasetApi) CreateDataset(ctx _context.Context, engineName string, id string, o ...CreateDatasetOptionalParameters) (ClusterTask, *_nethttp.Response, error) {
	...
	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type CreateDatasetOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".DatasetApi.CreateDataset")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/data/v1/{engineName}/datasources/{id}/datasets"
