...
func (a *DatabaseApi) CreateDatabase(ctx _context.Context, engineName string, orgName string, clusterName string, body Database) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/data/v1/{engineName}/organizations/{orgName}/clusters/{clusterName}/databases"
...
func (a *DatabaseApi) DeleteDatabase(ctx _context.Context, engineName string, orgName string, clusterName string, databaseName string) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/data/v1/{engineName}/organizations/{orgName}/clusters/{clusterName}/databases/{databaseName}"
	localVarPath = strings.Replace(localVarPath, "{"+"engineName"+"}", _neturl.PathEscape(common.ParameterToString(engineName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
