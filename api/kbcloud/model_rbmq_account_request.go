...
type RbmqAccountRequest struct {
...
// NewRbmqAccountRequest instantiates a new RbmqAccountRequest object.
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed.
func NewRbmqAccountRequest() *RbmqAccountRequest {
	this := RbmqAccountRequest{}
	return &this
}

// NewRbmqAccountRequestWithDefaults instantiates a new RbmqAccountRequest object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewRbmqAccountRequestWithDefaults() *RbmqAccountRequest {
	this := RbmqAccountRequest{}
	return &this
}

// GetUser returns the User field value if set, zero value otherwise.
func (o *RbmqAccountRequest) GetUser() RbmqUser {
	if o == nil || o.User == nil {
		var ret RbmqUser
		return ret
	}
...
func (o *RbmqAccountRequest) GetUserOk() (*RbmqUser, bool) {
	if o == nil || o.User == nil {
		return nil, false
	}
	return o.User, true
...
// and a boolean to check if the value has been set.
func (o *RbmqAccountRequest) GetUserPermissionOk() (*RbmqPermission, bool) {
	if o == nil || o.UserPermission == nil {
		return nil, false
	}
...
func (o *RbmqAccountRequest) HasUserPermission() bool {
...
func (o *RbmqAccountRequest) SetUserPermission(v RbmqPermission) {
	o.UserPermission = &v
}

// MarshalJSON serializes the struct using spec logic.
func (o RbmqAccountRequest) MarshalJSON() ([]byte, error) {
...
func (o *RbmqAccountRequest) UnmarshalJSON(bytes []byte) (err error) {
	all := struct {
		User           *RbmqUser       `json:"user,omitempty"`
		UserPermission *RbmqPermission `json:"userPermission,omitempty"`
	}{}
