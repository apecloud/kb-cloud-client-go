...
// CreateEsrally Create an esrally benchmark task.
func (a *BenchmarkApi) CreateEsrally(ctx _context.Context, orgName string, body Esrally) (Benchmark, *_nethttp.Response, error) {
	var (
	...
	apiInfo := common.APIInfo{
		Tag:         "benchmark",
		OperationID: "createEsrally",
		Path:        "/api/v1/organizations/{orgName}/benchmark/esrally",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".BenchmarkApi.CreateEsrally")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/benchmark/esrally"
...
func (a *BenchmarkApi) CreatePgbench(ctx _context.Context, orgName string, body Pgbench) (Benchmark, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/benchmark/pgbench"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
func (a *BenchmarkApi) CreateSysbench(ctx _context.Context, orgName string, body Sysbench) (Benchmark, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/benchmark/sysbench"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
func (a *BenchmarkApi) CreateTpcc(ctx _context.Context, orgName string, body Tpcc) (Benchmark, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/benchmark/tpcc"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
func (a *BenchmarkApi) CreateYcsb(ctx _context.Context, orgName string, body Ycsb) (Benchmark, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/benchmark/ycsb"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
func (a *BenchmarkApi) DeleteBenchmark(ctx _context.Context, orgName string, body DeleteBenchOption) (interface{}, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/benchmark"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
func (a *BenchmarkApi) GetBenchmark(ctx _context.Context, orgName string, benchmarkId string) (Benchmark, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/benchmark/{benchmarkId}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"benchmarkId"+"}", _neturl.PathEscape(common.ParameterToString(benchmarkId, "")), -1)
...
func (a *BenchmarkApi) ListBenchmark(ctx _context.Context, orgName string, o ...ListBenchmarkOptionalParameters) ([]Benchmark, *_nethttp.Response, error) {
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if optionalParams.Cluster != nil {
		localVarQueryParams.Add("cluster", common.ParameterToString(*optionalParams.Cluster, ""))
	}
	if optionalParams.BenchType != nil {
		localVarQueryParams.Add("benchType", common.ParameterToString(*optionalParams.BenchType, ""))
	}
