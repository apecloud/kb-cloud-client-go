...
type AiAgentCancelActionPlanResponse struct {
	...
	ApprovalStatus  AiAgentCancelActionPlanResponseApprovalStatus `json:"approvalStatus"`
...
func NewAiAgentCancelActionPlanResponse(actionPlanId string, approvalStatus AiAgentCancelActionPlanResponseApprovalStatus, executionStatus AiAgentExecutionStatus) *AiAgentCancelActionPlanResponse {
...
func (o *AiAgentCancelActionPlanResponse) GetApprovalStatus() AiAgentCancelActionPlanResponseApprovalStatus {
	if o == nil {
		var ret AiAgentCancelActionPlanResponseApprovalStatus
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AiAgentCancelActionPlanResponse) GetApprovalStatusOk() (*AiAgentCancelActionPlanResponseApprovalStatus, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AiAgentCancelActionPlanResponse) SetApprovalStatus(v AiAgentCancelActionPlanResponseApprovalStatus) {
	o.ApprovalStatus = v
}
