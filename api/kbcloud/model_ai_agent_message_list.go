...
type AiAgentMessageList struct {
	Items []AiAgentMessage `json:"items"`
...
func NewAiAgentMessageList(items []AiAgentMessage) *AiAgentMessageList {
	this := AiAgentMessageList{}
	this.Items = items
	return &this
}

// NewAiAgentMessageListWithDefaults instantiates a new AiAgentMessageList object.
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set.
func NewAiAgentMessageListWithDefaults() *AiAgentMessageList {
	this := AiAgentMessageList{}
	return &this
}
