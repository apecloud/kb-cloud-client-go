...
func (a *MarkClusterApi) MarkClusterRestoreCompleted(ctx _context.Context, orgName string, clusterName string) (*_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/clusters/{clusterName}/markClusterRestoreCompleted",
		Version:     "",
	}
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/markClusterRestoreCompleted"
