...
func (a *RedisApi) CreateRedisAccount(ctx _context.Context, orgName string, clusterName string, body ACLUser, o ...CreateRedisAccountOptionalParameters) (ClusterTask, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/data/redis/organizations/{orgName}/clusters/{clusterName}/accounts",
		Version:     "",
	}
...
func (a *RedisApi) DeleteRedisAccount(ctx _context.Context, orgName string, clusterName string, accountName string, o ...DeleteRedisAccountOptionalParameters) (ClusterTask, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/data/redis/organizations/{orgName}/clusters/{clusterName}/accounts/{accountName}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
...
// DisableRedisInsight disable redisInsight plugin.
func (a *RedisApi) DisableRedisInsight(ctx _context.Context, orgName string, clusterName string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/data/redis/organizations/{orgName}/clusters/{clusterName}/redisInsight",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".RedisApi.DisableRedisInsight")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/data/redis/organizations/{orgName}/clusters/{clusterName}/redisInsight"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
// EnableRedisInsight enable redisInsight plugin.
func (a *RedisApi) EnableRedisInsight(ctx _context.Context, orgName string, clusterName string, body RedisInsightEnableOpt) (RedisInsight, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue RedisInsight
	)
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".RedisApi.EnableRedisInsight")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// GetAvailableRedisInsight get available redisInsight.
func (a *RedisApi) GetAvailableRedisInsight(ctx _context.Context, orgName string, clusterName string) (RedisInsight, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".RedisApi.GetAvailableRedisInsight")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
