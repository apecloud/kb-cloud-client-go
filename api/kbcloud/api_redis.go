...
func (a *RedisApi) CreateRedisAccount(ctx _context.Context, orgName string, clusterName string, body ACLUser, o ...CreateRedisAccountOptionalParameters) (OpsRequestName, *_nethttp.Response, error) {
	var (
...
func (a *RedisApi) DeleteRedisAccount(ctx _context.Context, orgName string, clusterName string, accountName string, o ...DeleteRedisAccountOptionalParameters) (OpsRequestName, *_nethttp.Response, error) {
	var (
...
func (a *RedisApi) UpdateRedisAccount(ctx _context.Context, orgName string, clusterName string, accountName string, body ACLUser, o ...UpdateRedisAccountOptionalParameters) (OpsRequestName, *_nethttp.Response, error) {
	var (
