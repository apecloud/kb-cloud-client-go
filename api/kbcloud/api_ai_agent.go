...
// ApproveAIAgentToolConfirmationOptionalParameters holds optional parameters for ApproveAIAgentToolConfirmation.
type ApproveAIAgentToolConfirmationOptionalParameters struct {
	Body *AiAgentToolConfirmationDecisionRequest
}

// NewApproveAIAgentToolConfirmationOptionalParameters creates an empty struct for parameters.
func NewApproveAIAgentToolConfirmationOptionalParameters() *ApproveAIAgentToolConfirmationOptionalParameters {
	this := ApproveAIAgentToolConfirmationOptionalParameters{}
	return &this
}

// WithBody sets the corresponding parameter name and returns the struct.
func (r *ApproveAIAgentToolConfirmationOptionalParameters) WithBody(body AiAgentToolConfirmationDecisionRequest) *ApproveAIAgentToolConfirmationOptionalParameters {
	r.Body = &body
	return r
}
...
func (a *AIAgentApi) ApproveAIAgentToolConfirmation(ctx _context.Context, orgName string, conversationId string, confirmationId string, o ...ApproveAIAgentToolConfirmationOptionalParameters) (AiAgentToolConfirmationDecisionResponse, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue AiAgentToolConfirmationDecisionResponse
		optionalParams      ApproveAIAgentToolConfirmationOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type ApproveAIAgentToolConfirmationOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/tool-confirmations/{confirmationId}/approve",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".AIAgentApi.ApproveAIAgentToolConfirmation")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/tool-confirmations/{confirmationId}/approve"
...
func (a *AIAgentApi) BrowseAIAgentTurnActionArtifact(ctx _context.Context, orgName string, conversationId string, actionId string, artifactId string) (_io.Reader, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/turn-actions/{actionId}/artifacts/{artifactId}/browse",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".AIAgentApi.BrowseAIAgentTurnActionArtifact")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/turn-actions/{actionId}/artifacts/{artifactId}/browse"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"conversationId"+"}", _neturl.PathEscape(common.ParameterToString(conversationId, "")), -1)
...
func (a *AIAgentApi) DeleteAIAgentConversation(ctx _context.Context, orgName string, conversationId string) (AiAgentDeleteConversationResponse, *_nethttp.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		localVarReturnValue AiAgentDeleteConversationResponse
	)
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".AIAgentApi.DeleteAIAgentConversation")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *AIAgentApi) DownloadAIAgentTurnActionArtifact(ctx _context.Context, orgName string, conversationId string, actionId string, artifactId string) (_io.Reader, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/turn-actions/{actionId}/artifacts/{artifactId}/download",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".AIAgentApi.DownloadAIAgentTurnActionArtifact")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/turn-actions/{actionId}/artifacts/{artifactId}/download"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"conversationId"+"}", _neturl.PathEscape(common.ParameterToString(conversationId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"actionId"+"}", _neturl.PathEscape(common.ParameterToString(actionId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"artifactId"+"}", _neturl.PathEscape(common.ParameterToString(artifactId, "")), -1)
...
func (a *AIAgentApi) GetAIAgentStatus(ctx _context.Context, orgName string) (AiAgentRuntimeStatus, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/ai-agent/status",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".AIAgentApi.GetAIAgentStatus")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/ai-agent/status"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
func (a *AIAgentApi) GetAIAgentTurnAction(ctx _context.Context, orgName string, conversationId string, actionId string) (AiAgentTurnAction, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/turn-actions/{actionId}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/turn-actions/{actionId}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"conversationId"+"}", _neturl.PathEscape(common.ParameterToString(conversationId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"actionId"+"}", _neturl.PathEscape(common.ParameterToString(actionId, "")), -1)
...
func (r *ListAIAgentConversationsOptionalParameters) WithAfter(after string) *ListAIAgentConversationsOptionalParameters {
	r.After = &after
	return r
}
...
// WithAfter sets the corresponding parameter name and returns the struct.
func (r *ListAIAgentMessagesOptionalParameters) WithAfter(after string) *ListAIAgentMessagesOptionalParameters {
	r.After = &after
	return r
}
...
func (a *AIAgentApi) ListAIAgentTurnActions(ctx _context.Context, orgName string, conversationId string, o ...ListAIAgentTurnActionsOptionalParameters) (AiAgentTurnActionList, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/turn-actions",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/turn-actions"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"conversationId"+"}", _neturl.PathEscape(common.ParameterToString(conversationId, "")), -1)
...
// RejectAIAgentToolConfirmationOptionalParameters holds optional parameters for RejectAIAgentToolConfirmation.
type RejectAIAgentToolConfirmationOptionalParameters struct {
	Body *AiAgentToolConfirmationDecisionRequest
}

// NewRejectAIAgentToolConfirmationOptionalParameters creates an empty struct for parameters.
func NewRejectAIAgentToolConfirmationOptionalParameters() *RejectAIAgentToolConfirmationOptionalParameters {
	this := RejectAIAgentToolConfirmationOptionalParameters{}
	return &this
}

// WithBody sets the corresponding parameter name and returns the struct.
func (r *RejectAIAgentToolConfirmationOptionalParameters) WithBody(body AiAgentToolConfirmationDecisionRequest) *RejectAIAgentToolConfirmationOptionalParameters {
	r.Body = &body
	return r
}
...
func (a *AIAgentApi) RejectAIAgentToolConfirmation(ctx _context.Context, orgName string, conversationId string, confirmationId string, o ...RejectAIAgentToolConfirmationOptionalParameters) (AiAgentToolConfirmationDecisionResponse, *_nethttp.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		localVarReturnValue AiAgentToolConfirmationDecisionResponse
		optionalParams      RejectAIAgentToolConfirmationOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type RejectAIAgentToolConfirmationOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/tool-confirmations/{confirmationId}/reject",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".AIAgentApi.RejectAIAgentToolConfirmation")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/tool-confirmations/{confirmationId}/reject"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"conversationId"+"}", _neturl.PathEscape(common.ParameterToString(conversationId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"confirmationId"+"}", _neturl.PathEscape(common.ParameterToString(confirmationId, "")), -1)
...
func (a *AIAgentApi) SendAIAgentMessage(ctx _context.Context, orgName string, conversationId string, body AiAgentSendMessageRequest) (AiAgentSendMessageResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue AiAgentSendMessageResponse
	)
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".AIAgentApi.SendAIAgentMessage")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 || localVarHTTPResponse.StatusCode == 401 || localVarHTTPResponse.StatusCode == 403 || localVarHTTPResponse.StatusCode == 404 || localVarHTTPResponse.StatusCode == 409 || localVarHTTPResponse.StatusCode == 500 || localVarHTTPResponse.StatusCode == 503 {
			var v APIErrorResponse
			err = a.Client.Decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *AIAgentApi) StopAIAgentConversation(ctx _context.Context, orgName string, conversationId string) (AiAgentStopConversationResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue AiAgentStopConversationResponse
	)
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/stop",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".AIAgentApi.StopAIAgentConversation")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/stop"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"conversationId"+"}", _neturl.PathEscape(common.ParameterToString(conversationId, "")), -1)
...
// SubscribeAIAgentConversationEventsOptionalParameters holds optional parameters for SubscribeAIAgentConversationEvents.
type SubscribeAIAgentConversationEventsOptionalParameters struct {
	After *string
}

// NewSubscribeAIAgentConversationEventsOptionalParameters creates an empty struct for parameters.
func NewSubscribeAIAgentConversationEventsOptionalParameters() *SubscribeAIAgentConversationEventsOptionalParameters {
	this := SubscribeAIAgentConversationEventsOptionalParameters{}
	return &this
}

// WithAfter sets the corresponding parameter name and returns the struct.
func (r *SubscribeAIAgentConversationEventsOptionalParameters) WithAfter(after string) *SubscribeAIAgentConversationEventsOptionalParameters {
	r.After = &after
	return r
}
...
func (a *AIAgentApi) SubscribeAIAgentConversationEvents(ctx _context.Context, orgName string, conversationId string, o ...SubscribeAIAgentConversationEventsOptionalParameters) (AiAgentEvent, *_nethttp.Response, error) {
	var (
		...
		optionalParams      SubscribeAIAgentConversationEventsOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type SubscribeAIAgentConversationEventsOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/events",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".AIAgentApi.SubscribeAIAgentConversationEvents")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/ai-agent/conversations/{conversationId}/events"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"conversationId"+"}", _neturl.PathEscape(common.ParameterToString(conversationId, "")), -1)
