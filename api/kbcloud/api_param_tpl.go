...
func (a *ParamTplApi) CreateParamTpl(ctx _context.Context, orgName string, body ParamTplCreate) (ParamTplListItem, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/paramTpls"
...
func (a *ParamTplApi) CreateParamTplFromCluster(ctx _context.Context, orgName string, clusterName string, body ParamTplCreateFromCluster) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/paramTpls"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
func (a *ParamTplApi) DeleteParamTpl(ctx _context.Context, orgName string, paramTplName string) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/paramTpls/{paramTplName}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
func NewListParamTplOptionalParameters() *ListParamTplOptionalParameters {
	this := ListParamTplOptionalParameters{}
	return &this
}

// WithPartition sets the corresponding parameter name and returns the struct.
func (r *ListParamTplOptionalParameters) WithPartition(partition ParamTplPartition) *ListParamTplOptionalParameters {
	r.Partition = &partition
	return r
}

// WithVersion sets the corresponding parameter name and returns the struct.
func (r *ListParamTplOptionalParameters) WithVersion(version string) *ListParamTplOptionalParameters {
	r.Version = &version
	return r
}

// WithComponent sets the corresponding parameter name and returns the struct.
func (r *ListParamTplOptionalParameters) WithComponent(component string) *ListParamTplOptionalParameters {
	r.Component = &component
	return r
}
...
func (a *ParamTplApi) ListParamTpl(ctx _context.Context, orgName string, o ...ListParamTplOptionalParameters) (ParamTplList, *_nethttp.Response, error) {
	var (
		...
		optionalParams      ListParamTplOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type ListParamTplOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
...
func (a *ParamTplApi) PatchParamTplV2(ctx _context.Context, orgName string, paramTplName string, body ParamTplUpdate) (ParamTplListItem, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/paramTplsV2/{paramTplName}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/paramTplsV2/{paramTplName}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"paramTplName"+"}", _neturl.PathEscape(common.ParameterToString(paramTplName, "")), -1)
