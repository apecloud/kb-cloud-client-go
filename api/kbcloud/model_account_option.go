...
type AccountOption struct {
	...
	SupportMutipleComponent *bool                `json:"supportMutipleComponent,omitempty"`
...
func NewAccountOption(enabled bool, accountNamePattern string, create bool, resetPassword bool, delete bool) *AccountOption {
	...
	this.Delete = delete
	var supportMutipleComponent bool = false
	this.SupportMutipleComponent = &supportMutipleComponent
	return &this
}
...
// GetSupportMutipleComponent returns the SupportMutipleComponent field value if set, zero value otherwise.
func (o *AccountOption) GetSupportMutipleComponent() bool {
	if o == nil || o.SupportMutipleComponent == nil {
		var ret bool
		return ret
	}
	return *o.SupportMutipleComponent
}

// GetSupportMutipleComponentOk returns a tuple with the SupportMutipleComponent field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *AccountOption) GetSupportMutipleComponentOk() (*bool, bool) {
	if o == nil || o.SupportMutipleComponent == nil {
		return nil, false
	}
	return o.SupportMutipleComponent, true
}

// HasSupportMutipleComponent returns a boolean if a field has been set.
func (o *AccountOption) HasSupportMutipleComponent() bool {
	return o != nil && o.SupportMutipleComponent != nil
}

// SetSupportMutipleComponent gets a reference to the given bool and assigns it to the SupportMutipleComponent field.
func (o *AccountOption) SetSupportMutipleComponent(v bool) {
	o.SupportMutipleComponent = &v
}
...
func (o AccountOption) MarshalJSON() ([]byte, error) {
	...
	if o.SupportMutipleComponent != nil {
		toSerialize["supportMutipleComponent"] = o.SupportMutipleComponent
	}
...
func (o *AccountOption) UnmarshalJSON(bytes []byte) (err error) {
	...
	if err = common.Unmarshal(bytes, &additionalProperties); err == nil {
		common.DeleteKeys(additionalProperties, &[]string{"maxSuperUserAccount", "enabled", "privileges", "accountNamePattern", "create", "resetPassword", "delete", "displayRootAccount", "resetRootPassword", "supportMutipleComponent"})
	} else {
		return err
	}
	...
	o.SupportMutipleComponent = all.SupportMutipleComponent
