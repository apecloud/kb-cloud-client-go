...
type ComponentItemCreate struct {
	...
	// Per-template replicas and optional overlays (storageClassName, availabilityZone, env, annotations, labels, classCode). Node group is cluster-level and inherited. Required when the engine option declares instanceTemplate. Request instances fully replace the Helm chart instances list. Names must be in instanceTemplate.names. Component replicas must equal the sum of these replica counts.
...
func (o *ComponentItemCreate) GetInstanceTemplates() []InstanceTemplateCreate {
	if o == nil || o.InstanceTemplates == nil {
		var ret []InstanceTemplateCreate
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ComponentItemCreate) GetInstanceTemplatesOk() (*[]InstanceTemplateCreate, bool) {
	if o == nil || o.InstanceTemplates == nil {
		return nil, false
	}
...
func (o *ComponentItemCreate) HasInstanceTemplates() bool {
