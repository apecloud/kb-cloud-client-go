...
const (
	AiAgentProfileGlobalEntry      AiAgentProfile = "global-entry"
	AiAgentProfileClusterDiagnosis AiAgentProfile = "cluster-diagnosis"
)

var allowedAiAgentProfileEnumValues = []AiAgentProfile{
	AiAgentProfileGlobalEntry,
	AiAgentProfileClusterDiagnosis,
}
