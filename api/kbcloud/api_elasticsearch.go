...
func (a *ElasticsearchApi) ChangeElasticsearchSecurityUserPassword(ctx _context.Context, orgName string, clusterName string, username string, body ESSecurityPasswordRequest) (*_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ElasticsearchApi.ChangeElasticsearchSecurityUserPassword")
	if err != nil {
...
// DeleteElasticsearchSecurityRole Delete Elasticsearch security role.
func (a *ElasticsearchApi) DeleteElasticsearchSecurityRole(ctx _context.Context, orgName string, clusterName string, roleName string) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ElasticsearchApi.DeleteElasticsearchSecurityRole")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// DeleteElasticsearchSecurityRoleMapping Delete Elasticsearch security role mapping.
func (a *ElasticsearchApi) DeleteElasticsearchSecurityRoleMapping(ctx _context.Context, orgName string, clusterName string, mappingName string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ElasticsearchApi.DeleteElasticsearchSecurityRoleMapping")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// DeleteElasticsearchSecurityUser Delete Elasticsearch security user.
func (a *ElasticsearchApi) DeleteElasticsearchSecurityUser(ctx _context.Context, orgName string, clusterName string, username string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodDelete
		localVarPostBody   interface{}
	)
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ElasticsearchApi.DeleteElasticsearchSecurityUser")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// GetElasticsearchBuiltinPrivileges Get Elasticsearch builtin privileges.
func (a *ElasticsearchApi) GetElasticsearchBuiltinPrivileges(ctx _context.Context, orgName string, clusterName string) (map[string][]string, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ElasticsearchApi.GetElasticsearchBuiltinPrivileges")
	if err != nil {
...
func (a *ElasticsearchApi) GetElasticsearchSecurityRole(ctx _context.Context, orgName string, clusterName string, roleName string) (ESSecurityRoleDescriptor, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ElasticsearchApi.GetElasticsearchSecurityRole")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *ElasticsearchApi) GetElasticsearchSecurityRoleMapping(ctx _context.Context, orgName string, clusterName string, mappingName string) (ESSecurityRoleMapping, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ElasticsearchApi.GetElasticsearchSecurityRoleMapping")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *ElasticsearchApi) GetElasticsearchSecurityUser(ctx _context.Context, orgName string, clusterName string, username string) (ESSecurityUser, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ElasticsearchApi.GetElasticsearchSecurityUser")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *ElasticsearchApi) ListElasticsearchSecurityRoleMappings(ctx _context.Context, orgName string, clusterName string) (map[string]ESSecurityRoleMapping, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ElasticsearchApi.ListElasticsearchSecurityRoleMappings")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *ElasticsearchApi) ListElasticsearchSecurityRoles(ctx _context.Context, orgName string, clusterName string) (map[string]ESSecurityRoleDescriptor, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ElasticsearchApi.ListElasticsearchSecurityRoles")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *ElasticsearchApi) ListElasticsearchSecurityUsers(ctx _context.Context, orgName string, clusterName string) (map[string]ESSecurityUser, *_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ElasticsearchApi.ListElasticsearchSecurityUsers")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *ElasticsearchApi) PutElasticsearchSecurityRole(ctx _context.Context, orgName string, clusterName string, roleName string, body ESSecurityRoleDescriptor) (*_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ElasticsearchApi.PutElasticsearchSecurityRole")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *ElasticsearchApi) PutElasticsearchSecurityRoleMapping(ctx _context.Context, orgName string, clusterName string, mappingName string, body ESSecurityRoleMapping) (*_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ElasticsearchApi.PutElasticsearchSecurityRoleMapping")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *ElasticsearchApi) PutElasticsearchSecurityUser(ctx _context.Context, orgName string, clusterName string, username string, body ESPutSecurityUserRequest) (*_nethttp.Response, error) {
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ElasticsearchApi.PutElasticsearchSecurityUser")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// NewElasticsearchApi Returns NewElasticsearchApi.
func NewElasticsearchApi(client *common.APIClient) *ElasticsearchApi {
