...
func (a *MssqlApi) ManageMssqlTDEDatabase(ctx _context.Context, orgName string, clusterName string, o ...ManageMssqlTDEDatabaseOptionalParameters) (*_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/data/mssql/organizations/{orgName}/clusters/{clusterName}/tde",
		Version:     "",
	}
	...
	localVarPath := localBasePath + "/api/v1/data/mssql/organizations/{orgName}/clusters/{clusterName}/tde"
