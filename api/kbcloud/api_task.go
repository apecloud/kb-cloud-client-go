...
func (a *TaskApi) CancelTask(ctx _context.Context, orgName string, taskId string) (*_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/tasks/{taskId}/cancel",
		Version:     "",
	}
...
// Get task
func (a *TaskApi) GetTask(ctx _context.Context, orgName string, taskId string) (Task, *_nethttp.Response, error) {
	var (
	...
	apiInfo := common.APIInfo{
		Tag:         "task",
		OperationID: "getTask",
		Path:        "/api/v1/organizations/{orgName}/tasks/{taskId}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/tasks/{taskId}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"taskId"+"}", _neturl.PathEscape(common.ParameterToString(taskId, "")), -1)
...
// ListTaskEvents List operation events related to a task.
// List operation events whose recorded response contains the task ID.
func (a *TaskApi) ListTaskEvents(ctx _context.Context, orgName string, taskId string) (EventList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/tasks/{taskId}/events",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".TaskApi.ListTaskEvents")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/tasks/{taskId}/events"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"taskId"+"}", _neturl.PathEscape(common.ParameterToString(taskId, "")), -1)
...
// ListTasks List task.
// List tasks
func (a *TaskApi) ListTasks(ctx _context.Context, orgName string, start int64, end int64, o ...ListTasksOptionalParameters) (TaskList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/tasks",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/tasks"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
