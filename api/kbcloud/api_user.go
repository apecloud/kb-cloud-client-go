...
func (a *UserApi) CreateUserApikey(ctx _context.Context, body ApikeyCreate) (ApikeyWithSK, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/user/apikeys"
...
func (a *UserApi) DeleteApikey(ctx _context.Context, keyName string) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/user/apikey/{keyName}"
...
func (a *UserApi) PhoneVerification(ctx _context.Context, body interface{}) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/user/phone-verification-code"
...
// QueryOrgUsersOptionalParameters holds optional parameters for QueryOrgUsers.
type QueryOrgUsersOptionalParameters struct {
	UserName *string
	Email    *string
}

// NewQueryOrgUsersOptionalParameters creates an empty struct for parameters.
func NewQueryOrgUsersOptionalParameters() *QueryOrgUsersOptionalParameters {
	this := QueryOrgUsersOptionalParameters{}
	return &this
}

// WithUserName sets the corresponding parameter name and returns the struct.
func (r *QueryOrgUsersOptionalParameters) WithUserName(userName string) *QueryOrgUsersOptionalParameters {
	r.UserName = &userName
	return r
}

// WithEmail sets the corresponding parameter name and returns the struct.
func (r *QueryOrgUsersOptionalParameters) WithEmail(email string) *QueryOrgUsersOptionalParameters {
	r.Email = &email
	return r
}

// QueryOrgUsers Query users.
// Query users by name or email
func (a *UserApi) QueryOrgUsers(ctx _context.Context, o ...QueryOrgUsersOptionalParameters) (UserList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue UserList
		optionalParams      QueryOrgUsersOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type QueryOrgUsersOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	apiInfo := common.APIInfo{
		Tag:         "user",
		OperationID: "queryOrgUsers",
		Path:        "/api/v1/users",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".UserApi.QueryOrgUsers")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
	...
	if optionalParams.Email != nil {
		localVarQueryParams.Add("email", common.ParameterToString(*optionalParams.Email, ""))
	}
	localVarHeaderParams["Accept"] = "application/json"
...
// SendVerificationEmail Send verification email to user's email address..
...
func (a *UserApi) SendVerificationEmail(ctx _context.Context) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/user/verificationEmail"
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 401 || localVarHTTPResponse.StatusCode == 404 || localVarHTTPResponse.StatusCode == 500 {
			var v APIErrorResponse
			err = a.Client.Decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				return localVarHTTPResponse, newErr
...
func (a *UserApi) UpdateUserPassword(ctx _context.Context, body interface{}) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/user/password"
