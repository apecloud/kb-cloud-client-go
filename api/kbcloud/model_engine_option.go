...
type EngineOption struct {
	...
	// Number of data volume claim templates the engine chart can render for each component.
	// Frontend creation forms use this to render exact data0..dataN volume inputs for charts
	// whose storage template names are generated by a fixed count.
	//
...
func (o *EngineOption) GetDataVolumeCount() int64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned.
func (o *EngineOption) GetDataVolumeCountOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EngineOption) HasDataVolumeCount() bool {
...
func (o *EngineOption) UnsetDataVolumeCount() {
