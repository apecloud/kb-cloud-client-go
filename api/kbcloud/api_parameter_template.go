...
func (a *ParameterTemplateApi) CreateParameterTemplate(ctx _context.Context, orgName string, body ParamTplCreate) (ParamTplListItem, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/parameterTemplates",
		Version:     "",
	}
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/parameterTemplates"
...
func (a *ParameterTemplateApi) DeleteParameterTemplate(ctx _context.Context, orgName string, parameterTemplateName string) (*_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/parameterTemplate/{parameterTemplateName}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/parameterTemplate/{parameterTemplateName}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
func (a *ParameterTemplateApi) ExportParameterTemplateFromCluster(ctx _context.Context, orgName string, clusterName string, body ParamTplCreateFromCluster) (*_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/clusters/{clusterName}/parameterTemplate",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/parameterTemplate"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
// ListParameterTemplates List parameter templates in an Org.
func (a *ParameterTemplateApi) ListParameterTemplates(ctx _context.Context, orgName string, o ...ListParameterTemplatesOptionalParameters) (ParamTplList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
