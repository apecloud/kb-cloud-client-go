...
type AiAgentContinueReportRequest struct {
	...
	Mode    AiAgentReportContinueMode `json:"mode"`
...
func NewAiAgentContinueReportRequest(message string, mode AiAgentReportContinueMode) *AiAgentContinueReportRequest {
...
func (o *AiAgentContinueReportRequest) GetMode() AiAgentReportContinueMode {
	if o == nil {
		var ret AiAgentReportContinueMode
		return ret
	}
	return o.Mode
}
...
// and a boolean to check if the value has been set.
func (o *AiAgentContinueReportRequest) GetModeOk() (*AiAgentReportContinueMode, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Mode, true
...
func (o *AiAgentContinueReportRequest) SetMode(v AiAgentReportContinueMode) {
	o.Mode = v
}
