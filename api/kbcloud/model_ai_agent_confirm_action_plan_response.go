...
type AiAgentConfirmActionPlanResponse struct {
	...
	ApprovalStatus  AiAgentConfirmActionPlanResponseApprovalStatus `json:"approvalStatus"`
...
func NewAiAgentConfirmActionPlanResponse(actionPlanId string, approvalStatus AiAgentConfirmActionPlanResponseApprovalStatus, executionStatus AiAgentExecutionStatus) *AiAgentConfirmActionPlanResponse {
...
func (o *AiAgentConfirmActionPlanResponse) GetApprovalStatus() AiAgentConfirmActionPlanResponseApprovalStatus {
	if o == nil {
		var ret AiAgentConfirmActionPlanResponseApprovalStatus
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AiAgentConfirmActionPlanResponse) GetApprovalStatusOk() (*AiAgentConfirmActionPlanResponseApprovalStatus, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AiAgentConfirmActionPlanResponse) SetApprovalStatus(v AiAgentConfirmActionPlanResponseApprovalStatus) {
	o.ApprovalStatus = v
}
