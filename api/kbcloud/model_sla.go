...
// and a boolean to check if the value has been set.
func (o *SLA) GetSlaOk() (*float, bool) {
	if o == nil || o.Sla == nil {
		return nil, false
	}
	return o.Sla, true
...
// SetSla gets a reference to the given float and assigns it to the Sla field.
func (o *SLA) SetSla(v float) {
	o.Sla = &v
}
