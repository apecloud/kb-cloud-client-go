...
type AiAgentFeedbackRequest struct {
	Rating  AiAgentFeedbackRequestRating        `json:"rating"`
	Reasons []AiAgentFeedbackRequestReasonsItem `json:"reasons,omitempty"`
...
func NewAiAgentFeedbackRequest(rating AiAgentFeedbackRequestRating) *AiAgentFeedbackRequest {
...
func (o *AiAgentFeedbackRequest) GetRating() AiAgentFeedbackRequestRating {
	if o == nil {
		var ret AiAgentFeedbackRequestRating
		return ret
	}
	return o.Rating
}
...
func (o *AiAgentFeedbackRequest) GetRatingOk() (*AiAgentFeedbackRequestRating, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AiAgentFeedbackRequest) SetRating(v AiAgentFeedbackRequestRating) {
	o.Rating = v
}

// GetReasons returns the Reasons field value if set, zero value otherwise.
func (o *AiAgentFeedbackRequest) GetReasons() []AiAgentFeedbackRequestReasonsItem {
	if o == nil || o.Reasons == nil {
		var ret []AiAgentFeedbackRequestReasonsItem
		return ret
	}
	return o.Reasons
}
...
// and a boolean to check if the value has been set.
func (o *AiAgentFeedbackRequest) GetReasonsOk() (*[]AiAgentFeedbackRequestReasonsItem, bool) {
	if o == nil || o.Reasons == nil {
		return nil, false
	}
...
// SetReasons gets a reference to the given []AiAgentFeedbackRequestReasonsItem and assigns it to the Reasons field.
func (o *AiAgentFeedbackRequest) SetReasons(v []AiAgentFeedbackRequestReasonsItem) {
	o.Reasons = v
}
