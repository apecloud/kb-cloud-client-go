...
type AiAgentEvidenceDetail struct {
	...
	RedactionStatus *AiAgentEvidenceRedactionStatus `json:"redactionStatus,omitempty"`
...
func (o *AiAgentEvidenceDetail) GetRedactionStatus() AiAgentEvidenceRedactionStatus {
	if o == nil || o.RedactionStatus == nil {
		var ret AiAgentEvidenceRedactionStatus
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AiAgentEvidenceDetail) GetRedactionStatusOk() (*AiAgentEvidenceRedactionStatus, bool) {
	if o == nil || o.RedactionStatus == nil {
		return nil, false
	}
...
// SetRedactionStatus gets a reference to the given AiAgentEvidenceRedactionStatus and assigns it to the RedactionStatus field.
func (o *AiAgentEvidenceDetail) SetRedactionStatus(v AiAgentEvidenceRedactionStatus) {
	o.RedactionStatus = &v
}
