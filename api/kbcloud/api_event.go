...
func (a *EventApi) GetEventFilter(ctx _context.Context, orgName string, filterType EventFilterType, start int64, end int64, o ...GetEventFilterOptionalParameters) (EventFilterOptionList, *_nethttp.Response, error) {
	var (
