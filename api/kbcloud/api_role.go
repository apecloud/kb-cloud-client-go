...
// BatchAddRolePermissions Batch add permissions to a role.
...
func (a *RoleApi) BatchAddRolePermissions(ctx _context.Context, orgName string, roleName string, body []string) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/roles/{roleName}/permissions/batch"
...
// BatchRemoveRolePermissions Batch remove permissions from a role.
...
func (a *RoleApi) CreateRole(ctx _context.Context, orgName string, body RoleCreate) (Role, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/roles"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
func (a *RoleApi) DeleteRoleByName(ctx _context.Context, orgName string, roleName string) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/roles/{roleName}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"roleName"+"}", _neturl.PathEscape(common.ParameterToString(roleName, "")), -1)
...
func (a *RoleApi) ListOrgMemberPermission(ctx _context.Context, orgName string) (PermissionList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".RoleApi.ListOrgMemberPermission")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
func (a *RoleApi) ListRolePermissions(ctx _context.Context, orgName string, roleName string) (PermissionList, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/roles/{roleName}/permissions"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"roleName"+"}", _neturl.PathEscape(common.ParameterToString(roleName, "")), -1)
