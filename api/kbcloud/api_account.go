...
// CreateMssqlAccount Create mssql account.
// create an mssql account in cluster
func (a *AccountApi) CreateMssqlAccount(ctx _context.Context, orgName string, clusterName string, body Account) (ClusterTask, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
	...
	apiInfo := common.APIInfo{
		Tag:         "account",
		OperationID: "createMssqlAccount",
		Path:        "/api/v1/data/mssql/organizations/{orgName}/clusters/{clusterName}/accounts",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".AccountApi.CreateMssqlAccount")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// DeleteMssqlAccount Delete mssql cluster account.
// delete mssql account in cluster
func (a *AccountApi) DeleteMssqlAccount(ctx _context.Context, orgName string, clusterName string, accountName string) (ClusterTask, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodDelete
		localVarPostBody    interface{}
		localVarReturnValue ClusterTask
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/data/mssql/organizations/{orgName}/clusters/{clusterName}/accounts/{accountName}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/data/mssql/organizations/{orgName}/clusters/{clusterName}/accounts/{accountName}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"accountName"+"}", _neturl.PathEscape(common.ParameterToString(accountName, "")), -1)
