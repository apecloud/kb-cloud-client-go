...
func (a *OrganizationApi) DeleteOrg(ctx _context.Context, orgName string) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".OrganizationApi.DeleteOrg")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/organizations/{orgName}"
...
func (a *OrganizationApi) FreezeMember(ctx _context.Context, orgName string, memberId string) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/members/{memberId}/freeze"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
func NewListOrgOptionalParameters() *ListOrgOptionalParameters {
	this := ListOrgOptionalParameters{}
	return &this
}
...
func (a *OrganizationApi) ListOrg(ctx _context.Context, o ...ListOrgOptionalParameters) (UserOrgList, *_nethttp.Response, error) {
	...
	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type ListOrgOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
...
func (a *OrganizationApi) UnfreezeMember(ctx _context.Context, orgName string, memberId string) (*_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/members/{memberId}/unfreeze"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"memberId"+"}", _neturl.PathEscape(common.ParameterToString(memberId, "")), -1)
