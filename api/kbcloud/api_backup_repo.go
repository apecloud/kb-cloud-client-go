...
func (a *BackupRepoApi) GetBackupRepo(ctx _context.Context, environmentName string, backupRepoName string, o ...GetBackupRepoOptionalParameters) (BackupRepo, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/environments/{environmentName}/backupRepo/{backupRepoName}",
		Version:     "",
	}
	...
	localVarPath := localBasePath + "/api/v1/environments/{environmentName}/backupRepo/{backupRepoName}"
...
func (a *BackupRepoApi) ListBackupRepos(ctx _context.Context, orgName string) (BackupRepoList, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/backupRepo",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/backupRepo"
...
func (a *BackupRepoApi) ViewBackupRepo(ctx _context.Context, environmentName string, backupRepoName string, body BackupRepoView) (FileEntryList, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/environments/{environmentName}/backupRepo/{backupRepoName}/view",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/environments/{environmentName}/backupRepo/{backupRepoName}/view"
	localVarPath = strings.Replace(localVarPath, "{"+"environmentName"+"}", _neturl.PathEscape(common.ParameterToString(environmentName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"backupRepoName"+"}", _neturl.PathEscape(common.ParameterToString(backupRepoName, "")), -1)
