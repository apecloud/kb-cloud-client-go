...
func (a *InspectionApi) DeleteInspectionScript(ctx _context.Context, orgName string, scriptId string) (*_nethttp.Response, error) {
	var (
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/inspectionScripts/{scriptId}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/inspectionScripts/{scriptId}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
func (a *InspectionApi) UpdateInspectionScript(ctx _context.Context, orgName string, scriptId string, body InspectionScriptV2) (InspectionScriptV2, *_nethttp.Response, error) {
	var (
