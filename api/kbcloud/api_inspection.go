...
func (a *InspectionApi) CreateAutoInspection(ctx _context.Context, body AutoInspection) (AutoInspection, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/autoInspections"
...
func (a *InspectionApi) CreateInspectionScript(ctx _context.Context, body InspectionScript) (InspectionScript, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/inspectionScripts"
...
func (a *InspectionApi) CreateInspectionTaskByOrg(ctx _context.Context, orgName string, body InspectionTask) (*_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/inspectionTasksByOrg",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
...
func (a *InspectionApi) CreateInspectionTasksBatch(ctx _context.Context, body InspectionTaskBatchCreate) ([]InspectionTask, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/inspectionTasks/batch",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/inspectionTasks/batch"
...
func (a *InspectionApi) DeleteAutoInspection(ctx _context.Context, id string) (*_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/autoInspections/{id}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/autoInspections/{id}"
...
func (a *InspectionApi) DeleteInspectionScript(ctx _context.Context, scriptId string) (*_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/inspectionScripts/{scriptId}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/inspectionScripts/{scriptId}"
...
func (a *InspectionApi) GetAggregateTaskResult(ctx _context.Context, aggregateType AggregateTaskType, start int64, end int64, o ...GetAggregateTaskResultOptionalParameters) (AggregateTaskResultList, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/inspectionTasks/aggregate",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/inspectionTasks/aggregate"
...
func (a *InspectionApi) GetAutoInspection(ctx _context.Context, o ...GetAutoInspectionOptionalParameters) (AutoInspection, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/autoInspection"
...
func (a *InspectionApi) GetInspectionTaskByOrg(ctx _context.Context, orgName string, taskId string, o ...GetInspectionTaskByOrgOptionalParameters) (InspectionTask, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/inspectionTasksByOrg/{taskId}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/inspectionTasksByOrg/{taskId}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
