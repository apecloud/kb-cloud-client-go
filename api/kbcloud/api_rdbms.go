...
func (a *RdbmsApi) ListAvailableCollates(ctx _context.Context, engineName string, orgName string, clusterName string, charset string, o ...ListAvailableCollatesOptionalParameters) ([]string, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue []string
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	localVarQueryParams.Add("charset", common.ParameterToString(charset, ""))
	if optionalParams.Filter != nil {
		localVarQueryParams.Add("filter", common.ParameterToString(*optionalParams.Filter, ""))
	}
	localVarHeaderParams["Accept"] = "application/json"
...
func (a *RdbmsApi) ListAvailableCtypes(ctx _context.Context, engineName string, orgName string, clusterName string, charset string, o ...ListAvailableCtypesOptionalParameters) ([]string, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue []string
