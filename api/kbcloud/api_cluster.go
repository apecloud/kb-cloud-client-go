...
func (a *ClusterApi) BatchUpdateClusters(ctx _context.Context, orgName string, body ClusterBatchUpdate) (*_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/clusters/batch",
		Version:     "",
	}
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/batch"
...
func (a *ClusterApi) CreateCluster(ctx _context.Context, orgName string, body ClusterCreate) (Cluster, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
func (a *ClusterApi) DeleteCluster(ctx _context.Context, orgName string, clusterName string, o ...DeleteClusterOptionalParameters) (interface{}, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/clusters/{clusterName}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
func (a *ClusterApi) DescribeClusterHaHistory(ctx _context.Context, orgName string, clusterName string, start int64, end int64, o ...DescribeClusterHaHistoryOptionalParameters) (HaHistoryList, *_nethttp.Response, error) {
	var (
		...
		localVarPostBody    interface{}
		localVarReturnValue HaHistoryList
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/clusters/{clusterName}/haHistory",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/haHistory"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *ClusterApi) GetClusterByID(ctx _context.Context, orgName string, clusterId string, o ...GetClusterByIDOptionalParameters) (Cluster, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/clustersWithDelete/{clusterID}",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clustersWithDelete/{clusterID}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
...
func (a *ClusterApi) GetClusterInstanceLog(ctx _context.Context, orgName string, clusterName string, workloadName string, o ...GetClusterInstanceLogOptionalParameters) (string, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/clusters/{clusterName}/workloads/{workloadName}/log",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/workloads/{workloadName}/log"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *ClusterApi) GetInstacesMetrics(ctx _context.Context, orgName string, clusterName string) (InstanceMetricsList, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/clusters/{clusterName}/instances/metrics",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/instances/metrics"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func NewGetInstanceContainerLogOptionalParameters() *GetInstanceContainerLogOptionalParameters {
	this := GetInstanceContainerLogOptionalParameters{}
	return &this
}
...
// GetInstanceContainerLog Tail cluster instance container log.
// read log of the specified cluster instance
func (a *ClusterApi) GetInstanceContainerLog(ctx _context.Context, orgName string, clusterName string, instanceName string, o ...GetInstanceContainerLogOptionalParameters) (InstanceLog, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue InstanceLog
		optionalParams      GetInstanceContainerLogOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type GetInstanceContainerLogOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	apiInfo := common.APIInfo{
		Tag:         "cluster",
		OperationID: "getInstanceContainerLog",
		Path:        "/api/v1/organizations/{orgName}/clusters/{clusterName}/instances/{instanceName}/log",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterApi.GetInstanceContainerLog")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/instances/{instanceName}/log"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"instanceName"+"}", _neturl.PathEscape(common.ParameterToString(instanceName, "")), -1)
...
// GetSqlAudit Get SQL audit log status.
// Query the SQL audit log switch status for a cluster component
func (a *ClusterApi) GetSqlAudit(ctx _context.Context, orgName string, clusterName string, component string) (SqlAuditStatus, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue SqlAuditStatus
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "cluster",
		OperationID: "getSqlAudit",
		Path:        "/api/v1/organizations/{orgName}/clusters/{clusterName}/sqlAudit",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterApi.GetSqlAudit")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/sqlAudit"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
// GetTDE Get TDE status.
// Query the transparent data encryption switch status for a cluster component
func (a *ClusterApi) GetTDE(ctx _context.Context, orgName string, clusterName string, component string) (TdeStatus, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue TdeStatus
	)
	...
	apiInfo := common.APIInfo{
		Tag:         "cluster",
		OperationID: "getTDE",
		Path:        "/api/v1/organizations/{orgName}/clusters/{clusterName}/tde",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterApi.GetTDE")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/tde"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (r *ListClusterOptionalParameters) WithInclude(include []string) *ListClusterOptionalParameters {
	r.Include = &include
	return r
}
...
func (a *ClusterApi) ListCluster(ctx _context.Context, orgName string, o ...ListClusterOptionalParameters) (ClusterList, *_nethttp.Response, error) {
	...
	if optionalParams.Include != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				localVarQueryParams.Add("include", common.ParameterToString(s.Index(i), "multi"))
			}
		} else {
			localVarQueryParams.Add("include", common.ParameterToString(t, "multi"))
		}
	}
	localVarHeaderParams["Accept"] = "application/json"
...
func (a *ClusterApi) ListEndpoints(ctx _context.Context, orgName string, clusterName string, o ...ListEndpointsOptionalParameters) (EndpointList, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/clusters/{clusterName}/endpoints",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/endpoints"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *ClusterApi) ListInstance(ctx _context.Context, orgName string, clusterName string) (InstanceList, *_nethttp.Response, error) {
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/clusters/{clusterName}/instances",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/instances"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
// ListInstanceEventsOptionalParameters holds optional parameters for ListInstanceEvents.
type ListInstanceEventsOptionalParameters struct {
	ReturnNumber *int32
}

// NewListInstanceEventsOptionalParameters creates an empty struct for parameters.
func NewListInstanceEventsOptionalParameters() *ListInstanceEventsOptionalParameters {
	this := ListInstanceEventsOptionalParameters{}
	return &this
}

// WithReturnNumber sets the corresponding parameter name and returns the struct.
func (r *ListInstanceEventsOptionalParameters) WithReturnNumber(returnNumber int32) *ListInstanceEventsOptionalParameters {
	r.ReturnNumber = &returnNumber
	return r
}

// ListInstanceEvents List instance events.
func (a *ClusterApi) ListInstanceEvents(ctx _context.Context, orgName string, clusterName string, instanceName string, o ...ListInstanceEventsOptionalParameters) (InstanceEventList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodGet
		localVarPostBody    interface{}
		localVarReturnValue InstanceEventList
		optionalParams      ListInstanceEventsOptionalParameters
	)

	if len(o) > 1 {
		return localVarReturnValue, nil, common.ReportError("only one argument of type ListInstanceEventsOptionalParameters is allowed")
	}
	if len(o) == 1 {
		optionalParams = o[0]
	}
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/clusters/{clusterName}/instances/{instanceName}/events",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterApi.ListInstanceEvents")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/instances/{instanceName}/events"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"instanceName"+"}", _neturl.PathEscape(common.ParameterToString(instanceName, "")), -1)
	...
	localVarQueryParams := _neturl.Values{}
	localVarFormParams := _neturl.Values{}
	if optionalParams.ReturnNumber != nil {
		localVarQueryParams.Add("returnNumber", common.ParameterToString(*optionalParams.ReturnNumber, ""))
	}
	localVarHeaderParams["Accept"] = "application/json"
...
func (a *ClusterApi) QueryClusterMetrics(ctx _context.Context, orgName string, clusterName string, query string, queryType MetricsQueryType, start int64, end int64) (ClusterMetrics, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/metrics"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
// RestartInstance Restart instance of cluster.
func (a *ClusterApi) RestartInstance(ctx _context.Context, orgName string, clusterName string, instanceName string) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPost
		localVarPostBody   interface{}
	)
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/clusters/{clusterName}/instances/{instanceName}/restart",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterApi.RestartInstance")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/instances/{instanceName}/restart"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"instanceName"+"}", _neturl.PathEscape(common.ParameterToString(instanceName, "")), -1)
...
// TransitionClusterMode Transition cluster engine mode.
...
func (a *ClusterApi) TransitionClusterMode(ctx _context.Context, orgName string, clusterName string, body ClusterModeTransition) (OpsRequestName, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
	...
	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterApi.TransitionClusterMode")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// UpdateSqlAudit Update SQL audit log status.
// Enable or disable SQL audit log for a cluster component
func (a *ClusterApi) UpdateSqlAudit(ctx _context.Context, orgName string, clusterName string, body SqlAuditRequest) (SqlAuditResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue SqlAuditResponse
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "cluster",
		OperationID: "updateSqlAudit",
		Path:        "/api/v1/organizations/{orgName}/clusters/{clusterName}/sqlAudit",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterApi.UpdateSqlAudit")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// UpdateTDE Enable TDE.
// Enable transparent data encryption for a cluster component. Disabling TDE is not supported.
func (a *ClusterApi) UpdateTDE(ctx _context.Context, orgName string, clusterName string, body TdeRequest) (TdeResponse, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod  = _nethttp.MethodPost
		localVarPostBody    interface{}
		localVarReturnValue TdeResponse
	)

	// Add api info to context
	apiInfo := common.APIInfo{
		Tag:         "cluster",
		OperationID: "updateTDE",
		Path:        "/api/v1/organizations/{orgName}/clusters/{clusterName}/tde",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterApi.UpdateTDE")
	if err != nil {
		return localVarReturnValue, nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}
...
// ValidateClusterCreation Validate cluster creation.
func (a *ClusterApi) ValidateClusterCreation(ctx _context.Context, orgName string, body ClusterCreate) (*_nethttp.Response, error) {
	var (
		localVarHTTPMethod = _nethttp.MethodPost
		localVarPostBody   interface{}
	)
	...
	apiInfo := common.APIInfo{
		...
		Path:        "/api/v1/organizations/{orgName}/clusters/validate",
		Version:     "",
	}
	ctx = context.WithValue(ctx, common.APIInfoCtxKey, apiInfo)

	localBasePath, err := a.Client.Cfg.ServerURLWithContext(ctx, ".ClusterApi.ValidateClusterCreation")
	if err != nil {
		return nil, common.GenericOpenAPIError{ErrorMessage: err.Error()}
	}

	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/validate"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
