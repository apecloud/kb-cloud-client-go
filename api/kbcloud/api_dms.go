...
func (a *DmsApi) AlterVolumes(ctx _context.Context, orgName string, clusterName string, volumeName string, body interface{}) (string, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/volume/{volumeName}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"volumeName"+"}", _neturl.PathEscape(common.ParameterToString(volumeName, "")), -1)
...
func (a *DmsApi) CreateVolumes(ctx _context.Context, orgName string, clusterName string, body interface{}) (string, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/createVolume"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *DmsApi) ListVolumes(ctx _context.Context, orgName string, clusterName string) ([]DmsVolume, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/volumes"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
...
func (a *DmsApi) SetDefaultVolumes(ctx _context.Context, orgName string, clusterName string, volumeName string) (string, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/volume/{volumeName}/setDefault"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"volumeName"+"}", _neturl.PathEscape(common.ParameterToString(volumeName, "")), -1)
...
func (a *DmsApi) TextToSQL(ctx _context.Context, orgName string, clusterName string, id string, body TextToSQLRequest) (AnalysisResult, *_nethttp.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/organizations/{orgName}/clusters/{clusterName}/datasource/{id}/textToSQL"
	localVarPath = strings.Replace(localVarPath, "{"+"orgName"+"}", _neturl.PathEscape(common.ParameterToString(orgName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"clusterName"+"}", _neturl.PathEscape(common.ParameterToString(clusterName, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", _neturl.PathEscape(common.ParameterToString(id, "")), -1)
